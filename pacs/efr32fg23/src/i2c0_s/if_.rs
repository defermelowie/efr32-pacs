...
impl W {
    #[doc = "Bit 0 - START condition Interrupt Flag"]
    #[inline(always)]
    pub fn start(&mut self) -> StartW<'_, IfSpec> {
        StartW::new(self, 0)
    }
    #[doc = "Bit 1 - Repeated START condition Interrupt Flag"]
    #[inline(always)]
    pub fn rstart(&mut self) -> RstartW<'_, IfSpec> {
        RstartW::new(self, 1)
    }
    #[doc = "Bit 2 - Address Interrupt Flag"]
    #[inline(always)]
    pub fn addr(&mut self) -> AddrW<'_, IfSpec> {
        AddrW::new(self, 2)
    }
    #[doc = "Bit 3 - Transfer Completed Interrupt Flag"]
    #[inline(always)]
    ...
    #[doc = "Bit 6 - Acknowledge Received Interrupt Flag"]
    #[inline(always)]
    pub fn ack(&mut self) -> AckW<'_, IfSpec> {
        AckW::new(self, 6)
    }
    #[doc = "Bit 7 - Not Acknowledge Received Interrupt Flag"]
    #[inline(always)]
    pub fn nack(&mut self) -> NackW<'_, IfSpec> {
        NackW::new(self, 7)
    }
    #[doc = "Bit 8 - Leader STOP Condition Interrupt Flag"]
    #[inline(always)]
    pub fn mstop(&mut self) -> MstopW<'_, IfSpec> {
        MstopW::new(self, 8)
    }
    #[doc = "Bit 9 - Arbitration Lost Interrupt Flag"]
    #[inline(always)]
    pub fn arblost(&mut self) -> ArblostW<'_, IfSpec> {
        ArblostW::new(self, 9)
    }
    #[doc = "Bit 10 - Bus Error Interrupt Flag"]
    #[inline(always)]
    pub fn buserr(&mut self) -> BuserrW<'_, IfSpec> {
        BuserrW::new(self, 10)
    }
    #[doc = "Bit 11 - Bus Held Interrupt Flag"]
    #[inline(always)]
    pub fn bushold(&mut self) -> BusholdW<'_, IfSpec> {
    ...
    #[doc = "Bit 14 - Bus Idle Timeout Interrupt Flag"]
    #[inline(always)]
    pub fn bito(&mut self) -> BitoW<'_, IfSpec> {
        BitoW::new(self, 14)
    }
    #[doc = "Bit 15 - Clock Low Timeout Interrupt Flag"]
    #[inline(always)]
    pub fn clto(&mut self) -> CltoW<'_, IfSpec> {
        CltoW::new(self, 15)
    }
    #[doc = "Bit 16 - Follower STOP condition Interrupt Flag"]
    #[inline(always)]
    pub fn sstop(&mut self) -> SstopW<'_, IfSpec> {
        SstopW::new(self, 16)
    }
    #[doc = "Bit 17 - Receive Buffer Full Interrupt Flag"]
    #[inline(always)]
    ...
    #[doc = "Bit 18 - Clock Low Error Interrupt Flag"]
    #[inline(always)]
    pub fn clerr(&mut self) -> ClerrW<'_, IfSpec> {
        ClerrW::new(self, 18)
    }
    #[doc = "Bit 19 - SCL Error Interrupt Flag"]
    #[inline(always)]
    pub fn sclerr(&mut self) -> SclerrW<'_, IfSpec> {
        SclerrW::new(self, 19)
    }
    #[doc = "Bit 20 - SDA Error Interrupt Flag"]
    #[inline(always)]
    pub fn sdaerr(&mut self) -> SdaerrW<'_, IfSpec> {
        SdaerrW::new(self, 20)
    }
}

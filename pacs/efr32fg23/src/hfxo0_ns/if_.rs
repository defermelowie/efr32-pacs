...
impl W {
    ...
    #[doc = "Bit 2 - PRS Ready Interrupt"]
    #[inline(always)]
    pub fn prsrdy(&mut self) -> PrsrdyW<'_, IfSpec> {
        PrsrdyW::new(self, 2)
    }
    #[doc = "Bit 3 - BUFOUT Ready Interrupt"]
    #[inline(always)]
    pub fn bufoutrdy(&mut self) -> BufoutrdyW<'_, IfSpec> {
        BufoutrdyW::new(self, 3)
    }
    #[doc = "Bit 15 - BUFOUT FROZEN Interrupt"]
    #[inline(always)]
    pub fn bufoutfrozen(&mut self) -> BufoutfrozenW<'_, IfSpec> {
        BufoutfrozenW::new(self, 15)
    }
    #[doc = "Bit 20 - PRS Requset Error Interrupt"]
    #[inline(always)]
    pub fn prserr(&mut self) -> PrserrW<'_, IfSpec> {
        PrserrW::new(self, 20)
    }
    #[doc = "Bit 21 - BUFOUT Request Error Interrupt"]
    #[inline(always)]
    pub fn bufouterr(&mut self) -> BufouterrW<'_, IfSpec> {
        BufouterrW::new(self, 21)
    }
    #[doc = "Bit 27 - BUFOUT Freeze Error Interrupt"]
    #[inline(always)]
    pub fn bufoutfreezeerr(&mut self) -> BufoutfreezeerrW<'_, IfSpec> {
        BufoutfreezeerrW::new(self, 27)
    }
    #[doc = "Bit 28 - BUFOUT Did Not Start Error Interrupt"]
    #[inline(always)]
    pub fn bufoutdnserr(&mut self) -> BufoutdnserrW<'_, IfSpec> {
    ...
    #[doc = "Bit 30 - Low Frequency Timeout Error Interrupt"]
    #[inline(always)]
    pub fn lftimeouterr(&mut self) -> LftimeouterrW<'_, IfSpec> {

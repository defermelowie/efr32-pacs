...
#[doc = "Field `PFMXPPRF` reader - PFMXPPRF Secure Access"]
pub type PfmxpprfR = crate::BitReader;
#[doc = "Field `PFMXPPRF` writer - PFMXPPRF Secure Access"]
...
impl R {
    ...
    #[doc = "Bit 5 - PFMXPPRF Secure Access"]
    #[inline(always)]
    pub fn pfmxpprf(&self) -> PfmxpprfR {
        PfmxpprfR::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - RADIOAES Secure Access"]
    #[inline(always)]
    ...
    #[doc = "Bit 24 - AHBRADIO Secure Access"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 0 - SYSRTC Secure Access"]
    #[inline(always)]
    pub fn sysrtc(&mut self) -> SysrtcW<'_, Ppusatd1Spec> {
        SysrtcW::new(self, 0)
    }
    #[doc = "Bit 1 - LCD Secure Access"]
    #[inline(always)]
    pub fn lcd(&mut self) -> LcdW<'_, Ppusatd1Spec> {
        LcdW::new(self, 1)
    }
    #[doc = "Bit 2 - KEYSCAN Secure Access"]
    #[inline(always)]
    ...
    #[doc = "Bit 4 - LCDRF Secure Access"]
    #[inline(always)]
    pub fn lcdrf(&mut self) -> LcdrfW<'_, Ppusatd1Spec> {
        LcdrfW::new(self, 4)
    }
    #[doc = "Bit 5 - PFMXPPRF Secure Access"]
    #[inline(always)]
    pub fn pfmxpprf(&mut self) -> PfmxpprfW<'_, Ppusatd1Spec> {
    ...
    #[doc = "Bit 16 - LESENSE Secure Access"]
    #[inline(always)]
    pub fn lesense(&mut self) -> LesenseW<'_, Ppusatd1Spec> {

...
impl W {
    #[doc = "Bits 0:1 - CC Channel Mode"]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, Cc2CfgSpec> {
        ModeW::new(self, 0)
    }
    #[doc = "Bit 4 - Compare Output Initial State"]
    #[inline(always)]
    pub fn coist(&mut self) -> CoistW<'_, Cc2CfgSpec> {
        CoistW::new(self, 4)
    }
    #[doc = "Bits 17:18 - Input Selection"]
    #[inline(always)]
    pub fn insel(&mut self) -> InselW<'_, Cc2CfgSpec> {
        InselW::new(self, 17)
    }
    #[doc = "Bit 19 - PRS Configuration"]
    #[inline(always)]
    pub fn prsconf(&mut self) -> PrsconfW<'_, Cc2CfgSpec> {
        PrsconfW::new(self, 19)
    }
    #[doc = "Bit 20 - Digital Filter"]
    #[inline(always)]
    pub fn filt(&mut self) -> FiltW<'_, Cc2CfgSpec> {
        FiltW::new(self, 20)
    }
    #[doc = "Bit 21 - Input Capture FIFO watermark level"]
    #[inline(always)]
    pub fn icfwl(&mut self) -> IcfwlW<'_, Cc2CfgSpec> {
        IcfwlW::new(self, 21)
    }
}

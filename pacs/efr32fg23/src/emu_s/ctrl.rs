...
impl W {
    ...
    #[doc = "Bit 29 - EFP Direct Mode Enable"]
    #[inline(always)]
    pub fn efpdirectmodeen(&mut self) -> EfpdirectmodeenW<'_, CtrlSpec> {
        EfpdirectmodeenW::new(self, 29)
    }
    #[doc = "Bit 30 - EFP drives DECOUPLE"]
    #[inline(always)]
    pub fn efpdrvdecouple(&mut self) -> EfpdrvdecoupleW<'_, CtrlSpec> {
        EfpdrvdecoupleW::new(self, 30)
    }
    #[doc = "Bit 31 - EFP drives DVDD"]
    #[inline(always)]
    pub fn efpdrvdvdd(&mut self) -> EfpdrvdvddW<'_, CtrlSpec> {

...
impl RegisterBlock {
    ...
    #[doc = "0xb8 - MODEM DIN consumer register"]
    #[inline(always)]
    ...
    #[doc = "0xf0 - CLR consumer register"]
    #[inline(always)]

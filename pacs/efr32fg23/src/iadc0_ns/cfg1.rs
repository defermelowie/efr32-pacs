...
impl W {
    #[doc = "Bits 0:1 - ADC Mode"]
    #[inline(always)]
    pub fn adcmode(&mut self) -> AdcmodeW<'_, Cfg1Spec> {
        AdcmodeW::new(self, 0)
    }
    #[doc = "Bits 2:4 - High Speed OSR"]
    #[inline(always)]
    pub fn osrhs(&mut self) -> OsrhsW<'_, Cfg1Spec> {
        OsrhsW::new(self, 2)
    }
    #[doc = "Bits 12:14 - Analog Gain"]
    #[inline(always)]
    pub fn analoggain(&mut self) -> AnaloggainW<'_, Cfg1Spec> {
        AnaloggainW::new(self, 12)
    }
    #[doc = "Bits 16:18 - Reference Select"]
    #[inline(always)]
    pub fn refsel(&mut self) -> RefselW<'_, Cfg1Spec> {
        RefselW::new(self, 16)
    }
    #[doc = "Bits 21:23 - Digital Averaging"]
    #[inline(always)]
    pub fn digavg(&mut self) -> DigavgW<'_, Cfg1Spec> {
        DigavgW::new(self, 21)
    }
    #[doc = "Bits 28:29 - Two's Complement"]
    #[inline(always)]
    pub fn twoscompl(&mut self) -> TwoscomplW<'_, Cfg1Spec> {

...
impl W {
    #[doc = "Bits 4:6 - Slew Rate"]
    #[inline(always)]
    pub fn slewrate(&mut self) -> SlewrateW<'_, PortaCtrlSpec> {
        SlewrateW::new(self, 4)
    }
    #[doc = "Bit 12 - Data In Disable"]
    #[inline(always)]
    pub fn dindis(&mut self) -> DindisW<'_, PortaCtrlSpec> {
        DindisW::new(self, 12)
    }
    #[doc = "Bits 20:22 - Slew Rate Alt"]
    #[inline(always)]
    pub fn slewratealt(&mut self) -> SlewratealtW<'_, PortaCtrlSpec> {
        SlewratealtW::new(self, 20)
    }
    #[doc = "Bit 28 - Data In Disable Alt"]
    #[inline(always)]
    pub fn dindisalt(&mut self) -> DindisaltW<'_, PortaCtrlSpec> {

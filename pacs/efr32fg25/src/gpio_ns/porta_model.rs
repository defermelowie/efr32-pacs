...
impl W {
    #[doc = "Bits 0:3 - MODE n"]
    #[inline(always)]
    pub fn mode0(&mut self) -> Mode0W<'_, PortaModelSpec> {
        Mode0W::new(self, 0)
    }
    #[doc = "Bits 4:7 - MODE n"]
    #[inline(always)]
    pub fn mode1(&mut self) -> Mode1W<'_, PortaModelSpec> {
        Mode1W::new(self, 4)
    }
    #[doc = "Bits 8:11 - MODE n"]
    #[inline(always)]
    pub fn mode2(&mut self) -> Mode2W<'_, PortaModelSpec> {
        Mode2W::new(self, 8)
    }
    #[doc = "Bits 12:15 - MODE n"]
    #[inline(always)]
    pub fn mode3(&mut self) -> Mode3W<'_, PortaModelSpec> {
        Mode3W::new(self, 12)
    }
    #[doc = "Bits 16:19 - MODE n"]
    #[inline(always)]
    pub fn mode4(&mut self) -> Mode4W<'_, PortaModelSpec> {
        Mode4W::new(self, 16)
    }
    #[doc = "Bits 20:23 - MODE n"]
    #[inline(always)]
    pub fn mode5(&mut self) -> Mode5W<'_, PortaModelSpec> {
        Mode5W::new(self, 20)
    }
    #[doc = "Bits 24:27 - MODE n"]
    #[inline(always)]
    pub fn mode6(&mut self) -> Mode6W<'_, PortaModelSpec> {
        Mode6W::new(self, 24)
    }
    #[doc = "Bits 28:31 - MODE n"]
    #[inline(always)]
    pub fn mode7(&mut self) -> Mode7W<'_, PortaModelSpec> {
        Mode7W::new(self, 28)
    }
}

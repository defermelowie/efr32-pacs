#[doc = "Register `TIMER6_ROUTEEN` reader"]
pub type R = crate::R<Timer6RouteenSpec>;
#[doc = "Register `TIMER6_ROUTEEN` writer"]
pub type W = crate::W<Timer6RouteenSpec>;
...
impl W {
    #[doc = "Bit 0 - CC0 pin enable control bit"]
    #[inline(always)]
    pub fn cc0pen(&mut self) -> Cc0penW<'_, Timer6RouteenSpec> {
        Cc0penW::new(self, 0)
    }
    #[doc = "Bit 1 - CC1 pin enable control bit"]
    #[inline(always)]
    pub fn cc1pen(&mut self) -> Cc1penW<'_, Timer6RouteenSpec> {
        Cc1penW::new(self, 1)
    }
    #[doc = "Bit 2 - CC2 pin enable control bit"]
    #[inline(always)]
    pub fn cc2pen(&mut self) -> Cc2penW<'_, Timer6RouteenSpec> {
        Cc2penW::new(self, 2)
    }
    #[doc = "Bit 3 - CDTI0 pin enable control bit"]
    #[inline(always)]
    pub fn ccc0pen(&mut self) -> Ccc0penW<'_, Timer6RouteenSpec> {
        Ccc0penW::new(self, 3)
    }
    #[doc = "Bit 4 - CDTI1 pin enable control bit"]
    #[inline(always)]
    pub fn ccc1pen(&mut self) -> Ccc1penW<'_, Timer6RouteenSpec> {
        Ccc1penW::new(self, 4)
    }
    #[doc = "Bit 5 - CDTI2 pin enable control bit"]
    #[inline(always)]
    pub fn ccc2pen(&mut self) -> Ccc2penW<'_, Timer6RouteenSpec> {
        Ccc2penW::new(self, 5)
    }
}
...
pub struct Timer6RouteenSpec;
impl crate::RegisterSpec for Timer6RouteenSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`timer6_routeen::R`](R) reader structure"]
impl crate::Readable for Timer6RouteenSpec {}
#[doc = "`write(|w| ..)` method takes [`timer6_routeen::W`](W) writer structure"]
impl crate::Writable for Timer6RouteenSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets TIMER6_ROUTEEN to value 0"]
impl crate::Resettable for Timer6RouteenSpec {}

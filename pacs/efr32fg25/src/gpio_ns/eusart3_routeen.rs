#[doc = "Register `EUSART3_ROUTEEN` reader"]
pub type R = crate::R<Eusart3RouteenSpec>;
#[doc = "Register `EUSART3_ROUTEEN` writer"]
pub type W = crate::W<Eusart3RouteenSpec>;
...
impl W {
    #[doc = "Bit 0 - CS pin enable control bit"]
    #[inline(always)]
    pub fn cspen(&mut self) -> CspenW<'_, Eusart3RouteenSpec> {
        CspenW::new(self, 0)
    }
    #[doc = "Bit 1 - RTS pin enable control bit"]
    #[inline(always)]
    pub fn rtspen(&mut self) -> RtspenW<'_, Eusart3RouteenSpec> {
        RtspenW::new(self, 1)
    }
    #[doc = "Bit 2 - RX pin enable control bit"]
    #[inline(always)]
    pub fn rxpen(&mut self) -> RxpenW<'_, Eusart3RouteenSpec> {
        RxpenW::new(self, 2)
    }
    #[doc = "Bit 3 - SCLK pin enable control bit"]
    #[inline(always)]
    pub fn sclkpen(&mut self) -> SclkpenW<'_, Eusart3RouteenSpec> {
        SclkpenW::new(self, 3)
    }
    #[doc = "Bit 4 - TX pin enable control bit"]
    #[inline(always)]
    pub fn txpen(&mut self) -> TxpenW<'_, Eusart3RouteenSpec> {
        TxpenW::new(self, 4)
    }
}
#[doc = "EUSART3 pin enable\n\nYou can [`read`](crate::Reg::read) this register and get [`eusart3_routeen::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`eusart3_routeen::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Eusart3RouteenSpec;
impl crate::RegisterSpec for Eusart3RouteenSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`eusart3_routeen::R`](R) reader structure"]
impl crate::Readable for Eusart3RouteenSpec {}
#[doc = "`write(|w| ..)` method takes [`eusart3_routeen::W`](W) writer structure"]
impl crate::Writable for Eusart3RouteenSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets EUSART3_ROUTEEN to value 0"]
impl crate::Resettable for Eusart3RouteenSpec {}

...
#[doc = "Field `HOST2SRWBUSERR` reader - HOST2SRWBUSERR Interrupt Flag"]
pub type Host2srwbuserrR = crate::BitReader;
#[doc = "Field `HOST2SRWBUSERR` writer - HOST2SRWBUSERR Interrupt Flag"]
pub type Host2srwbuserrW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SRW2HOSTBUSERR` reader - SRW2HOSTBUSERR Interrupt Flag"]
pub type Srw2hostbuserrR = crate::BitReader;
#[doc = "Field `SRW2HOSTBUSERR` writer - SRW2HOSTBUSERR Interrupt Flag"]
pub type Srw2hostbuserrW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SRW2SOFTMBUSERR` reader - SRW2SOFTMBUSERR Interrupt Flag"]
pub type Srw2softmbuserrR = crate::BitReader;
#[doc = "Field `SRW2SOFTMBUSERR` writer - SRW2SOFTMBUSERR Interrupt Flag"]
pub type Srw2softmbuserrW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SOFTM2SRWBUSERR` reader - SOFTM2SRWBUSERR Interrupt Flag"]
pub type Softm2srwbuserrR = crate::BitReader;
#[doc = "Field `SOFTM2SRWBUSERR` writer - SOFTM2SRWBUSERR Interrupt Flag"]
pub type Softm2srwbuserrW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SOFTMBUSERRIF` reader - Softm bus error Interrupt Flag"]
pub type SoftmbuserrifR = crate::BitReader;
#[doc = "Field `SOFTMBUSERRIF` writer - Softm bus error Interrupt Flag"]
pub type SoftmbuserrifW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SOFTMDTCMRAMERRIF` reader - Softm DTCM Error Interrupt Flag"]
pub type SoftmdtcmramerrifR = crate::BitReader;
#[doc = "Field `SOFTMDTCMRAMERRIF` writer - Softm DTCM Error Interrupt Flag"]
pub type SoftmdtcmramerrifW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SOFTMITCMRAMERRIF` reader - Softm ITCM Error Interrupt Flag"]
pub type SoftmitcmramerrifR = crate::BitReader;
#[doc = "Field `SOFTMITCMRAMERRIF` writer - Softm ITCM Error Interrupt Flag"]
pub type SoftmitcmramerrifW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[doc = "Bit 15 - HOST2SRWBUSERR Interrupt Flag"]
    #[inline(always)]
    pub fn host2srwbuserr(&self) -> Host2srwbuserrR {
        Host2srwbuserrR::new(((self.bits >> 15) & 1) != 0)
    }
    #[doc = "Bit 16 - SRW2HOSTBUSERR Interrupt Flag"]
    #[inline(always)]
    pub fn srw2hostbuserr(&self) -> Srw2hostbuserrR {
        Srw2hostbuserrR::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 17 - SRW2SOFTMBUSERR Interrupt Flag"]
    #[inline(always)]
    pub fn srw2softmbuserr(&self) -> Srw2softmbuserrR {
        Srw2softmbuserrR::new(((self.bits >> 17) & 1) != 0)
    }
    #[doc = "Bit 18 - SOFTM2SRWBUSERR Interrupt Flag"]
    #[inline(always)]
    pub fn softm2srwbuserr(&self) -> Softm2srwbuserrR {
        Softm2srwbuserrR::new(((self.bits >> 18) & 1) != 0)
    }
    #[doc = "Bit 20 - Softm bus error Interrupt Flag"]
    #[inline(always)]
    pub fn softmbuserrif(&self) -> SoftmbuserrifR {
        SoftmbuserrifR::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 21 - Softm DTCM Error Interrupt Flag"]
    #[inline(always)]
    pub fn softmdtcmramerrif(&self) -> SoftmdtcmramerrifR {
        SoftmdtcmramerrifR::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bit 22 - Softm ITCM Error Interrupt Flag"]
    #[inline(always)]
    pub fn softmitcmramerrif(&self) -> SoftmitcmramerrifR {
        SoftmitcmramerrifR::new(((self.bits >> 22) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 17 - SRW2SOFTMBUSERR Interrupt Flag"]
    #[inline(always)]
    pub fn srw2softmbuserr(&mut self) -> Srw2softmbuserrW<'_, IfSpec> {
        Srw2softmbuserrW::new(self, 17)
    }
    #[doc = "Bit 18 - SOFTM2SRWBUSERR Interrupt Flag"]
    #[inline(always)]
    pub fn softm2srwbuserr(&mut self) -> Softm2srwbuserrW<'_, IfSpec> {
        Softm2srwbuserrW::new(self, 18)
    }
    #[doc = "Bit 20 - Softm bus error Interrupt Flag"]
    #[inline(always)]
    pub fn softmbuserrif(&mut self) -> SoftmbuserrifW<'_, IfSpec> {
        SoftmbuserrifW::new(self, 20)
    }
    #[doc = "Bit 21 - Softm DTCM Error Interrupt Flag"]
    #[inline(always)]
    pub fn softmdtcmramerrif(&mut self) -> SoftmdtcmramerrifW<'_, IfSpec> {
        SoftmdtcmramerrifW::new(self, 21)
    }
    #[doc = "Bit 22 - Softm ITCM Error Interrupt Flag"]
    #[inline(always)]
    pub fn softmitcmramerrif(&mut self) -> SoftmitcmramerrifW<'_, IfSpec> {
        SoftmitcmramerrifW::new(self, 22)
    }
    #[doc = "Bit 24 - SEQRAM Error 1-bit Interrupt Flag"]
    #[inline(always)]

...
#[doc = "Field `HOST2SRWBUSERR` reader - HOST2SRWBUSERR Interrupt Enable"]
pub type Host2srwbuserrR = crate::BitReader;
#[doc = "Field `HOST2SRWBUSERR` writer - HOST2SRWBUSERR Interrupt Enable"]
pub type Host2srwbuserrW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SRW2HOSTBUSERR` reader - SRW2HOSTBUSERR Interrupt Enable"]
pub type Srw2hostbuserrR = crate::BitReader;
#[doc = "Field `SRW2HOSTBUSERR` writer - SRW2HOSTBUSERR Interrupt Enable"]
pub type Srw2hostbuserrW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SRW2SOFTMBUSERR` reader - SRW2SOFTMBUSERR Interrupt Enable"]
pub type Srw2softmbuserrR = crate::BitReader;
#[doc = "Field `SRW2SOFTMBUSERR` writer - SRW2SOFTMBUSERR Interrupt Enable"]
pub type Srw2softmbuserrW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SOFTM2SRWBUSERR` reader - SOFTM2SRWBUSERR Interrupt Enable"]
pub type Softm2srwbuserrR = crate::BitReader;
#[doc = "Field `SOFTM2SRWBUSERR` writer - SOFTM2SRWBUSERR Interrupt Enable"]
pub type Softm2srwbuserrW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SOFTMBUSERRIEN` reader - Softm bus error interrupt Enable"]
pub type SoftmbuserrienR = crate::BitReader;
#[doc = "Field `SOFTMBUSERRIEN` writer - Softm bus error interrupt Enable"]
pub type SoftmbuserrienW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SOFTMDTCMRAMERRIEN` reader - Softm DTCM Error Interrupt Enable"]
pub type SoftmdtcmramerrienR = crate::BitReader;
#[doc = "Field `SOFTMDTCMRAMERRIEN` writer - Softm DTCM Error Interrupt Enable"]
pub type SoftmdtcmramerrienW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SOFTMITCMRAMERRIEN` reader - Softm ITCM Error Interrupt Enable"]
pub type SoftmitcmramerrienR = crate::BitReader;
#[doc = "Field `SOFTMITCMRAMERRIEN` writer - Softm ITCM Error Interrupt Enable"]
pub type SoftmitcmramerrienW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[doc = "Bit 15 - HOST2SRWBUSERR Interrupt Enable"]
    #[inline(always)]
    pub fn host2srwbuserr(&self) -> Host2srwbuserrR {
        Host2srwbuserrR::new(((self.bits >> 15) & 1) != 0)
    }
    #[doc = "Bit 16 - SRW2HOSTBUSERR Interrupt Enable"]
    #[inline(always)]
    pub fn srw2hostbuserr(&self) -> Srw2hostbuserrR {
        Srw2hostbuserrR::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 17 - SRW2SOFTMBUSERR Interrupt Enable"]
    #[inline(always)]
    pub fn srw2softmbuserr(&self) -> Srw2softmbuserrR {
        Srw2softmbuserrR::new(((self.bits >> 17) & 1) != 0)
    }
    #[doc = "Bit 18 - SOFTM2SRWBUSERR Interrupt Enable"]
    #[inline(always)]
    pub fn softm2srwbuserr(&self) -> Softm2srwbuserrR {
        Softm2srwbuserrR::new(((self.bits >> 18) & 1) != 0)
    }
    #[doc = "Bit 20 - Softm bus error interrupt Enable"]
    #[inline(always)]
    pub fn softmbuserrien(&self) -> SoftmbuserrienR {
        SoftmbuserrienR::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 21 - Softm DTCM Error Interrupt Enable"]
    #[inline(always)]
    pub fn softmdtcmramerrien(&self) -> SoftmdtcmramerrienR {
        SoftmdtcmramerrienR::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bit 22 - Softm ITCM Error Interrupt Enable"]
    #[inline(always)]
    pub fn softmitcmramerrien(&self) -> SoftmitcmramerrienR {
        SoftmitcmramerrienR::new(((self.bits >> 22) & 1) != 0)
    }
...
impl W {
    ...
    pub fn host2srwbuserr(&mut self) -> Host2srwbuserrW<'_, IenSpec> {
        Host2srwbuserrW::new(self, 15)
    }
    #[doc = "Bit 16 - SRW2HOSTBUSERR Interrupt Enable"]
    #[inline(always)]
    pub fn srw2hostbuserr(&mut self) -> Srw2hostbuserrW<'_, IenSpec> {
        Srw2hostbuserrW::new(self, 16)
    }
    #[doc = "Bit 17 - SRW2SOFTMBUSERR Interrupt Enable"]
    #[inline(always)]
    pub fn srw2softmbuserr(&mut self) -> Srw2softmbuserrW<'_, IenSpec> {
        Srw2softmbuserrW::new(self, 17)
    }
    #[doc = "Bit 18 - SOFTM2SRWBUSERR Interrupt Enable"]
    #[inline(always)]
    pub fn softm2srwbuserr(&mut self) -> Softm2srwbuserrW<'_, IenSpec> {
        Softm2srwbuserrW::new(self, 18)
    }
    #[doc = "Bit 20 - Softm bus error interrupt Enable"]
    #[inline(always)]
    pub fn softmbuserrien(&mut self) -> SoftmbuserrienW<'_, IenSpec> {
        SoftmbuserrienW::new(self, 20)
    }
    #[doc = "Bit 21 - Softm DTCM Error Interrupt Enable"]
    #[inline(always)]
    pub fn softmdtcmramerrien(&mut self) -> SoftmdtcmramerrienW<'_, IenSpec> {
        SoftmdtcmramerrienW::new(self, 21)
    }
    #[doc = "Bit 22 - Softm ITCM Error Interrupt Enable"]
    #[inline(always)]
    pub fn softmitcmramerrien(&mut self) -> SoftmitcmramerrienW<'_, IenSpec> {
        SoftmitcmramerrienW::new(self, 22)
    }
    #[doc = "Bit 24 - SEQRAM Error 1-bit Interrupt Enable"]
    #[inline(always)]

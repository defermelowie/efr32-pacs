#[doc = "Register `BUF3_CTRL` reader"]
pub type R = crate::R<Buf3CtrlSpec>;
#[doc = "Register `BUF3_CTRL` writer"]
pub type W = crate::W<Buf3CtrlSpec>;
#[doc = "Buffer Size\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bits 0:2 - Buffer Size"]
    #[inline(always)]
    pub fn size(&mut self) -> SizeW<'_, Buf3CtrlSpec> {
        SizeW::new(self, 0)
    }
}
#[doc = "No Description\n\nYou can [`read`](crate::Reg::read) this register and get [`buf3_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`buf3_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Buf3CtrlSpec;
impl crate::RegisterSpec for Buf3CtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`buf3_ctrl::R`](R) reader structure"]
impl crate::Readable for Buf3CtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`buf3_ctrl::W`](W) writer structure"]
impl crate::Writable for Buf3CtrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets BUF3_CTRL to value 0"]
impl crate::Resettable for Buf3CtrlSpec {}

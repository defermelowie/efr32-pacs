#[doc = "Register `BUF2_CTRL` reader"]
pub type R = crate::R<Buf2CtrlSpec>;
#[doc = "Register `BUF2_CTRL` writer"]
pub type W = crate::W<Buf2CtrlSpec>;
#[doc = "Buffer Size\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bits 0:2 - Buffer Size"]
    #[inline(always)]
    pub fn size(&mut self) -> SizeW<'_, Buf2CtrlSpec> {
        SizeW::new(self, 0)
    }
}
#[doc = "No Description\n\nYou can [`read`](crate::Reg::read) this register and get [`buf2_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`buf2_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Buf2CtrlSpec;
impl crate::RegisterSpec for Buf2CtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`buf2_ctrl::R`](R) reader structure"]
impl crate::Readable for Buf2CtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`buf2_ctrl::W`](W) writer structure"]
impl crate::Writable for Buf2CtrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets BUF2_CTRL to value 0"]
impl crate::Resettable for Buf2CtrlSpec {}

#[doc = "Register `SEQIEN` reader"]
pub type R = crate::R<SeqienSpec>;
#[doc = "Register `SEQIEN` writer"]
pub type W = crate::W<SeqienSpec>;
...
impl W {
    #[doc = "Bit 0 - BUF0OF Interrupt Enable"]
    #[inline(always)]
    pub fn buf0of(&mut self) -> Buf0ofW<'_, SeqienSpec> {
        Buf0ofW::new(self, 0)
    }
    #[doc = "Bit 1 - BUF0UF Interrupt Enable"]
    #[inline(always)]
    pub fn buf0uf(&mut self) -> Buf0ufW<'_, SeqienSpec> {
        Buf0ufW::new(self, 1)
    }
    #[doc = "Bit 2 - BUF0THR Interrupt Enable"]
    #[inline(always)]
    pub fn buf0thr(&mut self) -> Buf0thrW<'_, SeqienSpec> {
        Buf0thrW::new(self, 2)
    }
    #[doc = "Bit 3 - BUF0CORR Interrupt Enable"]
    #[inline(always)]
    pub fn buf0corr(&mut self) -> Buf0corrW<'_, SeqienSpec> {
        Buf0corrW::new(self, 3)
    }
    #[doc = "Bit 4 - BUF0NWA Interrupt Enable"]
    #[inline(always)]
    pub fn buf0nwa(&mut self) -> Buf0nwaW<'_, SeqienSpec> {
        Buf0nwaW::new(self, 4)
    }
    #[doc = "Bit 8 - BUF1OF Interrupt Enable"]
    #[inline(always)]
    pub fn buf1of(&mut self) -> Buf1ofW<'_, SeqienSpec> {
        Buf1ofW::new(self, 8)
    }
    #[doc = "Bit 9 - BUF1UF Interrupt Enable"]
    #[inline(always)]
    pub fn buf1uf(&mut self) -> Buf1ufW<'_, SeqienSpec> {
        Buf1ufW::new(self, 9)
    }
    #[doc = "Bit 10 - BUF1THR Interrupt Enable"]
    #[inline(always)]
    pub fn buf1thr(&mut self) -> Buf1thrW<'_, SeqienSpec> {
        Buf1thrW::new(self, 10)
    }
    #[doc = "Bit 11 - BUF1CORR Interrupt Enable"]
    #[inline(always)]
    pub fn buf1corr(&mut self) -> Buf1corrW<'_, SeqienSpec> {
        Buf1corrW::new(self, 11)
    }
    #[doc = "Bit 12 - BUF1NWA Interrupt Enable"]
    #[inline(always)]
    pub fn buf1nwa(&mut self) -> Buf1nwaW<'_, SeqienSpec> {
        Buf1nwaW::new(self, 12)
    }
    #[doc = "Bit 16 - BUF2OF Interrupt Enable"]
    #[inline(always)]
    pub fn buf2of(&mut self) -> Buf2ofW<'_, SeqienSpec> {
        Buf2ofW::new(self, 16)
    }
    #[doc = "Bit 17 - BUF2UF Interrupt Enable"]
    #[inline(always)]
    pub fn buf2uf(&mut self) -> Buf2ufW<'_, SeqienSpec> {
        Buf2ufW::new(self, 17)
    }
    #[doc = "Bit 18 - BUF2THR Interrupt Enable"]
    #[inline(always)]
    pub fn buf2thr(&mut self) -> Buf2thrW<'_, SeqienSpec> {
        Buf2thrW::new(self, 18)
    }
    #[doc = "Bit 19 - BUF2CORR Interrupt Enable"]
    #[inline(always)]
    pub fn buf2corr(&mut self) -> Buf2corrW<'_, SeqienSpec> {
        Buf2corrW::new(self, 19)
    }
    #[doc = "Bit 20 - BUF2NWA Interrupt Enable"]
    #[inline(always)]
    pub fn buf2nwa(&mut self) -> Buf2nwaW<'_, SeqienSpec> {
        Buf2nwaW::new(self, 20)
    }
    #[doc = "Bit 24 - BUF3OF Interrupt Enable"]
    #[inline(always)]
    pub fn buf3of(&mut self) -> Buf3ofW<'_, SeqienSpec> {
        Buf3ofW::new(self, 24)
    }
    #[doc = "Bit 25 - BUF3UF Interrupt Enable"]
    #[inline(always)]
    pub fn buf3uf(&mut self) -> Buf3ufW<'_, SeqienSpec> {
        Buf3ufW::new(self, 25)
    }
    #[doc = "Bit 26 - BUF3THR Interrupt Enable"]
    #[inline(always)]
    pub fn buf3thr(&mut self) -> Buf3thrW<'_, SeqienSpec> {
        Buf3thrW::new(self, 26)
    }
    #[doc = "Bit 27 - BUF3CORR Interrupt Enable"]
    #[inline(always)]
    pub fn buf3corr(&mut self) -> Buf3corrW<'_, SeqienSpec> {
        Buf3corrW::new(self, 27)
    }
    #[doc = "Bit 28 - BUF3NWA Interrupt Enable"]
    #[inline(always)]
    pub fn buf3nwa(&mut self) -> Buf3nwaW<'_, SeqienSpec> {
        Buf3nwaW::new(self, 28)
    }
    #[doc = "Bit 31 - BUSERROR Interrupt Enable"]
    #[inline(always)]
    pub fn buserror(&mut self) -> BuserrorW<'_, SeqienSpec> {
        BuserrorW::new(self, 31)
    }
}
#[doc = "No Description\n\nYou can [`read`](crate::Reg::read) this register and get [`seqien::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`seqien::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SeqienSpec;
impl crate::RegisterSpec for SeqienSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`seqien::R`](R) reader structure"]
impl crate::Readable for SeqienSpec {}
#[doc = "`write(|w| ..)` method takes [`seqien::W`](W) writer structure"]
impl crate::Writable for SeqienSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SEQIEN to value 0"]
impl crate::Resettable for SeqienSpec {}

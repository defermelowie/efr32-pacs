...
impl W {
    #[doc = "Bit 0 - Buffer 0 Overflow"]
    #[inline(always)]
    pub fn buf0of(&mut self) -> Buf0ofW<'_, IfSpec> {
        Buf0ofW::new(self, 0)
    }
    #[doc = "Bit 1 - Buffer 0 Underflow"]
    #[inline(always)]
    pub fn buf0uf(&mut self) -> Buf0ufW<'_, IfSpec> {
        Buf0ufW::new(self, 1)
    }
    #[doc = "Bit 2 - Buffer 0 Threshold Event"]
    #[inline(always)]
    pub fn buf0thr(&mut self) -> Buf0thrW<'_, IfSpec> {
        Buf0thrW::new(self, 2)
    }
    #[doc = "Bit 3 - Buffer 0 Corrupt"]
    #[inline(always)]
    pub fn buf0corr(&mut self) -> Buf0corrW<'_, IfSpec> {
        Buf0corrW::new(self, 3)
    }
    #[doc = "Bit 4 - Buffer 0 Not Word-Aligned"]
    #[inline(always)]
    pub fn buf0nwa(&mut self) -> Buf0nwaW<'_, IfSpec> {
        Buf0nwaW::new(self, 4)
    }
    #[doc = "Bit 8 - Buffer 1 Overflow"]
    #[inline(always)]
    pub fn buf1of(&mut self) -> Buf1ofW<'_, IfSpec> {
        Buf1ofW::new(self, 8)
    }
    #[doc = "Bit 9 - Buffer 1 Underflow"]
    #[inline(always)]
    pub fn buf1uf(&mut self) -> Buf1ufW<'_, IfSpec> {
        Buf1ufW::new(self, 9)
    }
    #[doc = "Bit 10 - Buffer 1 Threshold Event"]
    #[inline(always)]
    pub fn buf1thr(&mut self) -> Buf1thrW<'_, IfSpec> {
        Buf1thrW::new(self, 10)
    }
    #[doc = "Bit 11 - Buffer 1 Corrupt"]
    #[inline(always)]
    pub fn buf1corr(&mut self) -> Buf1corrW<'_, IfSpec> {
        Buf1corrW::new(self, 11)
    }
    #[doc = "Bit 12 - Buffer 1 Not Word-Aligned"]
    #[inline(always)]
    pub fn buf1nwa(&mut self) -> Buf1nwaW<'_, IfSpec> {
        Buf1nwaW::new(self, 12)
    }
    #[doc = "Bit 16 - Buffer 2 Overflow"]
    #[inline(always)]
    pub fn buf2of(&mut self) -> Buf2ofW<'_, IfSpec> {
        Buf2ofW::new(self, 16)
    }
    #[doc = "Bit 17 - Buffer 2 Underflow"]
    #[inline(always)]
    pub fn buf2uf(&mut self) -> Buf2ufW<'_, IfSpec> {
        Buf2ufW::new(self, 17)
    }
    #[doc = "Bit 18 - Buffer 2 Threshold Event"]
    #[inline(always)]
    pub fn buf2thr(&mut self) -> Buf2thrW<'_, IfSpec> {
        Buf2thrW::new(self, 18)
    }
    #[doc = "Bit 19 - Buffer 2 Corrupt"]
    #[inline(always)]
    pub fn buf2corr(&mut self) -> Buf2corrW<'_, IfSpec> {
        Buf2corrW::new(self, 19)
    }
    #[doc = "Bit 20 - Buffer 2 Not Word-Aligned"]
    #[inline(always)]
    pub fn buf2nwa(&mut self) -> Buf2nwaW<'_, IfSpec> {
        Buf2nwaW::new(self, 20)
    }
    #[doc = "Bit 24 - Buffer 3 Overflow"]
    #[inline(always)]
    pub fn buf3of(&mut self) -> Buf3ofW<'_, IfSpec> {
        Buf3ofW::new(self, 24)
    }
    #[doc = "Bit 25 - Buffer 3 Underflow"]
    #[inline(always)]
    pub fn buf3uf(&mut self) -> Buf3ufW<'_, IfSpec> {
        Buf3ufW::new(self, 25)
    }
    #[doc = "Bit 26 - Buffer 3 Threshold Event"]
    #[inline(always)]
    pub fn buf3thr(&mut self) -> Buf3thrW<'_, IfSpec> {
        Buf3thrW::new(self, 26)
    }
    #[doc = "Bit 27 - Buffer 3 Corrupt"]
    #[inline(always)]
    pub fn buf3corr(&mut self) -> Buf3corrW<'_, IfSpec> {
        Buf3corrW::new(self, 27)
    }
    #[doc = "Bit 28 - Buffer 3 Not Word-Aligned"]
    #[inline(always)]
    pub fn buf3nwa(&mut self) -> Buf3nwaW<'_, IfSpec> {
        Buf3nwaW::new(self, 28)
    }
    #[doc = "Bit 31 - Bus Error"]
    #[inline(always)]
    pub fn buserror(&mut self) -> BuserrorW<'_, IfSpec> {

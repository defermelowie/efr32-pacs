#[doc = "Register `BUF3_THRESHOLDCTRL` reader"]
pub type R = crate::R<Buf3ThresholdctrlSpec>;
#[doc = "Register `BUF3_THRESHOLDCTRL` writer"]
pub type W = crate::W<Buf3ThresholdctrlSpec>;
...
impl W {
    #[doc = "Bits 0:12 - Buffer Threshold Value"]
    #[inline(always)]
    pub fn threshold(&mut self) -> ThresholdW<'_, Buf3ThresholdctrlSpec> {
        ThresholdW::new(self, 0)
    }
    #[doc = "Bit 13 - Buffer Threshold Mode"]
    #[inline(always)]
    pub fn thresholdmode(&mut self) -> ThresholdmodeW<'_, Buf3ThresholdctrlSpec> {
        ThresholdmodeW::new(self, 13)
    }
}
#[doc = "No Description\n\nYou can [`read`](crate::Reg::read) this register and get [`buf3_thresholdctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`buf3_thresholdctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Buf3ThresholdctrlSpec;
impl crate::RegisterSpec for Buf3ThresholdctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`buf3_thresholdctrl::R`](R) reader structure"]
impl crate::Readable for Buf3ThresholdctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`buf3_thresholdctrl::W`](W) writer structure"]
impl crate::Writable for Buf3ThresholdctrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets BUF3_THRESHOLDCTRL to value 0"]
impl crate::Resettable for Buf3ThresholdctrlSpec {}

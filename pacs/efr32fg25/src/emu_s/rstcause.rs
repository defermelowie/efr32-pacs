...
impl R {
    ...
    #[doc = "Bit 12 - LEBOD3 Reset"]
    #[inline(always)]
    pub fn iovdd1bod(&self) -> Iovdd1bodR {
        Iovdd1bodR::new(((self.bits >> 12) & 1) != 0)
    }
    ...
    #[doc = "Bit 20 - LEBOD4 Reset"]
    #[inline(always)]
    pub fn iovdd2bod(&self) -> Iovdd2bodR {
        Iovdd2bodR::new(((self.bits >> 20) & 1) != 0)
    }

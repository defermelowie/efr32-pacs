...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn pagelock6(&self) -> &Pagelock6 {
        &self.pagelock6
    }
    #[doc = "0x13c - No Description"]
    #[inline(always)]
    pub const fn pagelock7(&self) -> &Pagelock7 {
        &self.pagelock7
    }
}
...
#[doc = "No Description"]
pub mod pagelock5;
#[doc = "PAGELOCK6 (rw) register accessor: No Description\n\nYou can [`read`](crate::Reg::read) this register and get [`pagelock6::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pagelock6::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pagelock6`] module"]
#[doc(alias = "PAGELOCK6")]
pub type Pagelock6 = crate::Reg<pagelock6::Pagelock6Spec>;
#[doc = "No Description"]
pub mod pagelock6;
#[doc = "PAGELOCK7 (rw) register accessor: No Description\n\nYou can [`read`](crate::Reg::read) this register and get [`pagelock7::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pagelock7::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pagelock7`] module"]
#[doc(alias = "PAGELOCK7")]
pub type Pagelock7 = crate::Reg<pagelock7::Pagelock7Spec>;
#[doc = "No Description"]
pub mod pagelock7;

...
impl W {
    #[doc = "Bits 0:12 - IN EP FIFOn xmit RAM Start Addr"]
    #[inline(always)]
    pub fn inepntxfstaddr(&mut self) -> InepntxfstaddrW<'_, Dieptxf7Spec> {
        InepntxfstaddrW::new(self, 0)
    }
    #[doc = "Bits 16:25 - IN Endpoint TxFIFO Depth"]
    #[inline(always)]
    pub fn inepntxfdep(&mut self) -> InepntxfdepW<'_, Dieptxf7Spec> {
...
#[doc = "`reset()` method sets DIEPTXF7 to value 0x0300_1800"]
impl crate::Resettable for Dieptxf7Spec {
    const RESET_VALUE: u32 = 0x0300_1800;
}

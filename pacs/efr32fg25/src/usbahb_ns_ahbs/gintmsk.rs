...
#[doc = "Field `SOFMSK` reader - Start of (micro)Frame Mask"]
pub type SofmskR = crate::BitReader;
#[doc = "Field `SOFMSK` writer - Start of (micro)Frame Mask"]
...
#[doc = "Field `NPTXFEMPMSK` reader - NP TXFIFO Empty Msk"]
pub type NptxfempmskR = crate::BitReader;
#[doc = "Field `NPTXFEMPMSK` writer - NP TXFIFO Empty Msk"]
pub type NptxfempmskW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `GINNAKEFFMSK` reader - Global Non-per IN NAK Eff Mask"]
pub type GinnakeffmskR = crate::BitReader;
#[doc = "Field `GINNAKEFFMSK` writer - Global Non-per IN NAK Eff Mask"]
...
#[doc = "Field `ISOOUTDROPMSK` reader - Iso OUT Pkt Dropped IRQ Mask"]
pub type IsooutdropmskR = crate::BitReader;
#[doc = "Field `ISOOUTDROPMSK` writer - Iso OUT Pkt Dropped IRQ Mask"]
pub type IsooutdropmskW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `EOPFMSK` reader - End of Periodic Frame Irq Mask"]
pub type EopfmskR = crate::BitReader;
#[doc = "Field `EOPFMSK` writer - End of Periodic Frame Irq Mask"]
pub type EopfmskW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `EPMISMSK` reader - Endpoint Mismatch Interrupt Mask"]
pub type EpmismskR = crate::BitReader;
#[doc = "Field `EPMISMSK` writer - Endpoint Mismatch Interrupt Mask"]
...
#[doc = "Field `INCOMPISOINMSK` reader - Incomp Iso IN Transfer Mask"]
pub type IncompisoinmskR = crate::BitReader;
#[doc = "Field `INCOMPISOINMSK` writer - Incomp Iso IN Transfer Mask"]
pub type IncompisoinmskW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `INCOMPLISOOUTMSK` reader - Incomp Iso OUT Transfer Mask"]
pub type IncomplisooutmskR = crate::BitReader;
#[doc = "Field `INCOMPLISOOUTMSK` writer - Incomp Iso OUT Transfer Mask"]
pub type IncomplisooutmskW<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `WKUPINTMSK` reader - Resume/Remote WkUp Det Irq Mask"]
pub type WkupintmskR = crate::BitReader;
#[doc = "Field `WKUPINTMSK` writer - Resume/Remote WkUp Det Irq Mask"]
...
impl R {
    ...
    #[doc = "Bit 5 - NP TXFIFO Empty Msk"]
    #[inline(always)]
    pub fn nptxfempmsk(&self) -> NptxfempmskR {
        NptxfempmskR::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - Global Non-per IN NAK Eff Mask"]
    #[inline(always)]
    ...
    #[doc = "Bit 14 - Iso OUT Pkt Dropped IRQ Mask"]
    #[inline(always)]
    pub fn isooutdropmsk(&self) -> IsooutdropmskR {
        IsooutdropmskR::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 15 - End of Periodic Frame Irq Mask"]
    #[inline(always)]
    ...
    #[doc = "Bit 20 - Incomp Iso IN Transfer Mask"]
    #[inline(always)]
    pub fn incompisoinmsk(&self) -> IncompisoinmskR {
        IncompisoinmskR::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 21 - Incomp Iso OUT Transfer Mask"]
    #[inline(always)]
    pub fn incomplisooutmsk(&self) -> IncomplisooutmskR {
        IncomplisooutmskR::new(((self.bits >> 21) & 1) != 0)
    }
    ...
    #[doc = "Bit 31 - Resume/Remote WkUp Det Irq Mask"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 21 - Incomp Iso OUT Transfer Mask"]
    #[inline(always)]
    pub fn incomplisooutmsk(&mut self) -> IncomplisooutmskW<'_, GintmskSpec> {
        IncomplisooutmskW::new(self, 21)
    }
    #[doc = "Bit 22 - Data Fetch Suspended Mask"]
    #[inline(always)]

#[doc = "Register `DEVOUTEP4_CTL` reader"]
pub type R = crate::R<Devoutep4CtlSpec>;
#[doc = "Register `DEVOUTEP4_CTL` writer"]
pub type W = crate::W<Devoutep4CtlSpec>;
...
impl W {
    #[doc = "Bits 0:10 - Maximum Packet Size"]
    #[inline(always)]
    pub fn mps(&mut self) -> MpsW<'_, Devoutep4CtlSpec> {
        MpsW::new(self, 0)
    }
    #[doc = "Bit 15 - USB Active Endpoint"]
    #[inline(always)]
    pub fn usbactep(&mut self) -> UsbactepW<'_, Devoutep4CtlSpec> {
        UsbactepW::new(self, 15)
    }
    #[doc = "Bits 18:19 - Endpoint Type"]
    #[inline(always)]
    pub fn eptype(&mut self) -> EptypeW<'_, Devoutep4CtlSpec> {
        EptypeW::new(self, 18)
    }
    #[doc = "Bit 20 - Snoop Mode"]
    #[inline(always)]
    pub fn snp(&mut self) -> SnpW<'_, Devoutep4CtlSpec> {
        SnpW::new(self, 20)
    }
    #[doc = "Bit 21 - Handshake"]
    #[inline(always)]
    pub fn stall(&mut self) -> StallW<'_, Devoutep4CtlSpec> {
        StallW::new(self, 21)
    }
    #[doc = "Bit 26 - Clear NAK"]
    #[inline(always)]
    pub fn cnak(&mut self) -> CnakW<'_, Devoutep4CtlSpec> {
        CnakW::new(self, 26)
    }
    #[doc = "Bit 27 - Set NAK"]
    #[inline(always)]
    pub fn snak(&mut self) -> SnakW<'_, Devoutep4CtlSpec> {
        SnakW::new(self, 27)
    }
    #[doc = "Bit 28 - Set DATA0 PID, even fr"]
    #[inline(always)]
    pub fn setd0pidef(&mut self) -> Setd0pidefW<'_, Devoutep4CtlSpec> {
        Setd0pidefW::new(self, 28)
    }
    #[doc = "Bit 29 - Set DATA1 PID, odd fr"]
    #[inline(always)]
    pub fn setd1pidof(&mut self) -> Setd1pidofW<'_, Devoutep4CtlSpec> {
        Setd1pidofW::new(self, 29)
    }
    #[doc = "Bit 30 - Endpoint Disable"]
    #[inline(always)]
    pub fn epdis(&mut self) -> EpdisW<'_, Devoutep4CtlSpec> {
        EpdisW::new(self, 30)
    }
    #[doc = "Bit 31 - Endpoint Enable"]
    #[inline(always)]
    pub fn epena(&mut self) -> EpenaW<'_, Devoutep4CtlSpec> {
        EpenaW::new(self, 31)
    }
}
#[doc = "No Description\n\nYou can [`read`](crate::Reg::read) this register and get [`devoutep4_ctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`devoutep4_ctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Devoutep4CtlSpec;
impl crate::RegisterSpec for Devoutep4CtlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`devoutep4_ctl::R`](R) reader structure"]
impl crate::Readable for Devoutep4CtlSpec {}
#[doc = "`write(|w| ..)` method takes [`devoutep4_ctl::W`](W) writer structure"]
impl crate::Writable for Devoutep4CtlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DEVOUTEP4_CTL to value 0"]
impl crate::Resettable for Devoutep4CtlSpec {}

...
#[doc = "Field `RSTPDWNMODULE` reader - RST Power-Down Modules"]
pub type RstpdwnmoduleR = crate::BitReader;
#[doc = "Field `RSTPDWNMODULE` writer - RST Power-Down Modules"]
pub type RstpdwnmoduleW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `PHYSLEEP` reader - New BitField"]
pub type PhysleepR = crate::BitReader;
#[doc = "Field `L1SUSPENDED` reader - New BitField"]
pub type L1suspendedR = crate::BitReader;
impl R {
    #[doc = "Bit 0 - Stop Pclk"]
    #[inline(always)]
    ...
    #[doc = "Bit 3 - RST Power-Down Modules"]
    #[inline(always)]

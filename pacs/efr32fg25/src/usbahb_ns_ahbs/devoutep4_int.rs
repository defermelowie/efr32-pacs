#[doc = "Register `DEVOUTEP4_INT` reader"]
pub type R = crate::R<Devoutep4IntSpec>;
#[doc = "Register `DEVOUTEP4_INT` writer"]
pub type W = crate::W<Devoutep4IntSpec>;
...
impl W {
    #[doc = "Bit 0 - Transfer Completed Interrupt"]
    #[inline(always)]
    pub fn xfercompl(&mut self) -> XfercomplW<'_, Devoutep4IntSpec> {
        XfercomplW::new(self, 0)
    }
    #[doc = "Bit 1 - Endpoint Disabled Interrupt"]
    #[inline(always)]
    pub fn epdisbld(&mut self) -> EpdisbldW<'_, Devoutep4IntSpec> {
        EpdisbldW::new(self, 1)
    }
    #[doc = "Bit 2 - AHB Error"]
    #[inline(always)]
    pub fn ahberr(&mut self) -> AhberrW<'_, Devoutep4IntSpec> {
        AhberrW::new(self, 2)
    }
    #[doc = "Bit 3 - Phase Done"]
    #[inline(always)]
    pub fn setup(&mut self) -> SetupW<'_, Devoutep4IntSpec> {
        SetupW::new(self, 3)
    }
    #[doc = "Bit 4 - OUT Token recvd when EP Disabled"]
    #[inline(always)]
    pub fn outtknepdis(&mut self) -> OuttknepdisW<'_, Devoutep4IntSpec> {
        OuttknepdisW::new(self, 4)
    }
    #[doc = "Bit 5 - Status Phase recvd For ctrl Write"]
    #[inline(always)]
    pub fn stsphsercvd(&mut self) -> StsphsercvdW<'_, Devoutep4IntSpec> {
        StsphsercvdW::new(self, 5)
    }
    #[doc = "Bit 6 - Back-to-Back SETUP Packets recvd"]
    #[inline(always)]
    pub fn back2backsetup(&mut self) -> Back2backsetupW<'_, Devoutep4IntSpec> {
        Back2backsetupW::new(self, 6)
    }
    #[doc = "Bit 8 - OUT Packet Error"]
    #[inline(always)]
    pub fn outpkterr(&mut self) -> OutpkterrW<'_, Devoutep4IntSpec> {
        OutpkterrW::new(self, 8)
    }
    #[doc = "Bit 9 - BNA (Buffer Not Available) IRQ"]
    #[inline(always)]
    pub fn bnaintr(&mut self) -> BnaintrW<'_, Devoutep4IntSpec> {
        BnaintrW::new(self, 9)
    }
    #[doc = "Bit 11 - Packet Drop Status"]
    #[inline(always)]
    pub fn pktdrpsts(&mut self) -> PktdrpstsW<'_, Devoutep4IntSpec> {
        PktdrpstsW::new(self, 11)
    }
    #[doc = "Bit 12 - Babble Error Interupt"]
    #[inline(always)]
    pub fn bbleerr(&mut self) -> BbleerrW<'_, Devoutep4IntSpec> {
        BbleerrW::new(self, 12)
    }
    #[doc = "Bit 13 - NAK Interrupt"]
    #[inline(always)]
    pub fn nakintrpt(&mut self) -> NakintrptW<'_, Devoutep4IntSpec> {
        NakintrptW::new(self, 13)
    }
    #[doc = "Bit 14 - NYET Interrupt"]
    #[inline(always)]
    pub fn nyetintrpt(&mut self) -> NyetintrptW<'_, Devoutep4IntSpec> {
        NyetintrptW::new(self, 14)
    }
    #[doc = "Bit 15 - Setup PKT received Interrupt"]
    #[inline(always)]
    pub fn stuppktrcvd(&mut self) -> StuppktrcvdW<'_, Devoutep4IntSpec> {
        StuppktrcvdW::new(self, 15)
    }
}
#[doc = "No Description\n\nYou can [`read`](crate::Reg::read) this register and get [`devoutep4_int::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`devoutep4_int::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Devoutep4IntSpec;
impl crate::RegisterSpec for Devoutep4IntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`devoutep4_int::R`](R) reader structure"]
impl crate::Readable for Devoutep4IntSpec {}
#[doc = "`write(|w| ..)` method takes [`devoutep4_int::W`](W) writer structure"]
impl crate::Writable for Devoutep4IntSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DEVOUTEP4_INT to value 0"]
impl crate::Resettable for Devoutep4IntSpec {}

#[doc = "Register `DEVINEP5_INT` reader"]
pub type R = crate::R<Devinep5IntSpec>;
#[doc = "Register `DEVINEP5_INT` writer"]
pub type W = crate::W<Devinep5IntSpec>;
...
impl W {
    #[doc = "Bit 0 - Transfer Completed IRQ"]
    #[inline(always)]
    pub fn xfercompl(&mut self) -> XfercomplW<'_, Devinep5IntSpec> {
        XfercomplW::new(self, 0)
    }
    #[doc = "Bit 1 - Endpoint Disabled IRQ"]
    #[inline(always)]
    pub fn epdisbld(&mut self) -> EpdisbldW<'_, Devinep5IntSpec> {
        EpdisbldW::new(self, 1)
    }
    #[doc = "Bit 2 - AHB Error"]
    #[inline(always)]
    pub fn ahberr(&mut self) -> AhberrW<'_, Devinep5IntSpec> {
        AhberrW::new(self, 2)
    }
    #[doc = "Bit 3 - COndition"]
    #[inline(always)]
    pub fn timeout(&mut self) -> TimeoutW<'_, Devinep5IntSpec> {
        TimeoutW::new(self, 3)
    }
    #[doc = "Bit 4 - IN Token recvd When TxFIFO is Empty"]
    #[inline(always)]
    pub fn intkntxfemp(&mut self) -> IntkntxfempW<'_, Devinep5IntSpec> {
        IntkntxfempW::new(self, 4)
    }
    #[doc = "Bit 5 - IN Token recvd with EP Mismatch"]
    #[inline(always)]
    pub fn intknepmis(&mut self) -> IntknepmisW<'_, Devinep5IntSpec> {
        IntknepmisW::new(self, 5)
    }
    #[doc = "Bit 6 - IN Endpoint NAK Effective"]
    #[inline(always)]
    pub fn inepnakeff(&mut self) -> InepnakeffW<'_, Devinep5IntSpec> {
        InepnakeffW::new(self, 6)
    }
    #[doc = "Bit 8 - FIFO Underrun"]
    #[inline(always)]
    pub fn txfifoundrn(&mut self) -> TxfifoundrnW<'_, Devinep5IntSpec> {
        TxfifoundrnW::new(self, 8)
    }
    #[doc = "Bit 9 - BNA (Buffer Not Available) IRQ"]
    #[inline(always)]
    pub fn bnaintr(&mut self) -> BnaintrW<'_, Devinep5IntSpec> {
        BnaintrW::new(self, 9)
    }
    #[doc = "Bit 11 - Packet Drop Status"]
    #[inline(always)]
    pub fn pktdrpsts(&mut self) -> PktdrpstsW<'_, Devinep5IntSpec> {
        PktdrpstsW::new(self, 11)
    }
    #[doc = "Bit 12 - Babble Interrupt"]
    #[inline(always)]
    pub fn bbleerr(&mut self) -> BbleerrW<'_, Devinep5IntSpec> {
        BbleerrW::new(self, 12)
    }
    #[doc = "Bit 13 - NAK Interrupt"]
    #[inline(always)]
    pub fn nakintrpt(&mut self) -> NakintrptW<'_, Devinep5IntSpec> {
        NakintrptW::new(self, 13)
    }
    #[doc = "Bit 14 - NYET Interrupt"]
    #[inline(always)]
    pub fn nyetintrpt(&mut self) -> NyetintrptW<'_, Devinep5IntSpec> {
        NyetintrptW::new(self, 14)
    }
}
#[doc = "No Description\n\nYou can [`read`](crate::Reg::read) this register and get [`devinep5_int::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`devinep5_int::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Devinep5IntSpec;
impl crate::RegisterSpec for Devinep5IntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`devinep5_int::R`](R) reader structure"]
impl crate::Readable for Devinep5IntSpec {}
#[doc = "`write(|w| ..)` method takes [`devinep5_int::W`](W) writer structure"]
impl crate::Writable for Devinep5IntSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DEVINEP5_INT to value 0x80"]
impl crate::Resettable for Devinep5IntSpec {

...
pub enum Clksel {
    ...
    Clkin0 = 4,
    #[doc = "5: RFFPLL0SYS is clocking SYSCLK"]
    Rffpll0sys = 5,
}
...
impl ClkselR {
    ...
    #[inline(always)]
    pub fn is_rffpll0sys(&self) -> bool {
        *self == Clksel::Rffpll0sys
    }
}
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "RFFPLL0SYS is clocking SYSCLK"]
    #[inline(always)]
    pub fn rffpll0sys(self) -> &'a mut crate::W<REG> {
        self.variant(Clksel::Rffpll0sys)
    }
}
#[doc = "PCLK Prescaler\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]

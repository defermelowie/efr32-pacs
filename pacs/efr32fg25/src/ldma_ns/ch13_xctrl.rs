#[doc = "Register `CH13_XCTRL` reader"]
pub type R = crate::R<Ch13XctrlSpec>;
#[doc = "Register `CH13_XCTRL` writer"]
pub type W = crate::W<Ch13XctrlSpec>;
...
impl W {
    #[doc = "Bit 4 - Destination Interleave"]
    #[inline(always)]
    pub fn dstilen(&mut self) -> DstilenW<'_, Ch13XctrlSpec> {
        DstilenW::new(self, 4)
    }
    #[doc = "Bits 5:6 - Interleave Mode"]
    #[inline(always)]
    pub fn ilmode(&mut self) -> IlmodeW<'_, Ch13XctrlSpec> {
        IlmodeW::new(self, 5)
    }
    #[doc = "Bit 7 - Allow AHB buffering"]
    #[inline(always)]
    pub fn bufferable(&mut self) -> BufferableW<'_, Ch13XctrlSpec> {
        BufferableW::new(self, 7)
    }
}
#[doc = "Channel Extended Descriptor Control Register (Writes will only take effect when EN=1)\n\nYou can [`read`](crate::Reg::read) this register and get [`ch13_xctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch13_xctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ch13XctrlSpec;
impl crate::RegisterSpec for Ch13XctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch13_xctrl::R`](R) reader structure"]
impl crate::Readable for Ch13XctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`ch13_xctrl::W`](W) writer structure"]
impl crate::Writable for Ch13XctrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH13_XCTRL to value 0"]
impl crate::Resettable for Ch13XctrlSpec {}

...
impl R {
    ...
    pub fn chgrant(&self) -> ChgrantR {
        ChgrantR::new(((self.bits >> 3) & 0x0f) as u8)
    }
    #[doc = "Bits 8:11 - Errant Channel Number"]
    #[inline(always)]
    pub fn cherror(&self) -> CherrorR {
        CherrorR::new(((self.bits >> 8) & 0x0f) as u8)
    }
...
#[doc = "`reset()` method sets STATUS to value 0x1000_0078"]
impl crate::Resettable for StatusSpec {
    const RESET_VALUE: u32 = 0x1000_0078;
}

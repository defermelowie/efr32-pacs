#[doc = "Register `CH4_XCTRL` reader"]
pub type R = crate::R<Ch4XctrlSpec>;
#[doc = "Register `CH4_XCTRL` writer"]
pub type W = crate::W<Ch4XctrlSpec>;
...
impl W {
    #[doc = "Bit 4 - Destination Interleave"]
    #[inline(always)]
    pub fn dstilen(&mut self) -> DstilenW<'_, Ch4XctrlSpec> {
        DstilenW::new(self, 4)
    }
    #[doc = "Bits 5:6 - Interleave Mode"]
    #[inline(always)]
    pub fn ilmode(&mut self) -> IlmodeW<'_, Ch4XctrlSpec> {
        IlmodeW::new(self, 5)
    }
    #[doc = "Bit 7 - Allow AHB buffering"]
    #[inline(always)]
    pub fn bufferable(&mut self) -> BufferableW<'_, Ch4XctrlSpec> {
        BufferableW::new(self, 7)
    }
}
#[doc = "Channel Extended Descriptor Control Register (Writes will only take effect when EN=1)\n\nYou can [`read`](crate::Reg::read) this register and get [`ch4_xctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch4_xctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ch4XctrlSpec;
impl crate::RegisterSpec for Ch4XctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch4_xctrl::R`](R) reader structure"]
impl crate::Readable for Ch4XctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`ch4_xctrl::W`](W) writer structure"]
impl crate::Writable for Ch4XctrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH4_XCTRL to value 0"]
impl crate::Resettable for Ch4XctrlSpec {}

...
#[doc = "Field `TIMER5` reader - Enable Bus Clock"]
pub type Timer5R = crate::BitReader;
#[doc = "Field `TIMER5` writer - Enable Bus Clock"]
...
impl W {
    ...
    #[doc = "Bit 9 - Enable Bus Clock"]
    #[inline(always)]
    pub fn timer5(&mut self) -> Timer5W<'_, Clken0Spec> {
        Timer5W::new(self, 9)
    }
    #[doc = "Bit 10 - Enable Bus Clock"]
    #[inline(always)]

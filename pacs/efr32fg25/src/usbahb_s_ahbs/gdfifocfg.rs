...
#[doc = "`reset()` method sets GDFIFOCFG to value 0x02ec_0300"]
impl crate::Resettable for GdfifocfgSpec {
    const RESET_VALUE: u32 = 0x02ec_0300;
}

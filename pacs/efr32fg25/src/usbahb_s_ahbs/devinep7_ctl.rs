#[doc = "Register `DEVINEP7_CTL` reader"]
pub type R = crate::R<Devinep7CtlSpec>;
#[doc = "Register `DEVINEP7_CTL` writer"]
pub type W = crate::W<Devinep7CtlSpec>;
...
impl W {
    #[doc = "Bits 0:10 - Maximum Packet Size"]
    #[inline(always)]
    pub fn mps(&mut self) -> MpsW<'_, Devinep7CtlSpec> {
        MpsW::new(self, 0)
    }
    #[doc = "Bit 15 - USB ACtive Endpoint"]
    #[inline(always)]
    pub fn usbactep(&mut self) -> UsbactepW<'_, Devinep7CtlSpec> {
        UsbactepW::new(self, 15)
    }
    #[doc = "Bits 18:19 - Endpoint Type"]
    #[inline(always)]
    pub fn eptype(&mut self) -> EptypeW<'_, Devinep7CtlSpec> {
        EptypeW::new(self, 18)
    }
    #[doc = "Bit 21 - Handshake"]
    #[inline(always)]
    pub fn stall(&mut self) -> StallW<'_, Devinep7CtlSpec> {
        StallW::new(self, 21)
    }
    #[doc = "Bits 22:25 - TxFIFO Number"]
    #[inline(always)]
    pub fn txfnum(&mut self) -> TxfnumW<'_, Devinep7CtlSpec> {
        TxfnumW::new(self, 22)
    }
    #[doc = "Bit 26 - Clear NAK"]
    #[inline(always)]
    pub fn cnak(&mut self) -> CnakW<'_, Devinep7CtlSpec> {
        CnakW::new(self, 26)
    }
    #[doc = "Bit 27 - Set NAK"]
    #[inline(always)]
    pub fn snak(&mut self) -> SnakW<'_, Devinep7CtlSpec> {
        SnakW::new(self, 27)
    }
    #[doc = "Bit 28 - Set DATA0 PID / Even Frame"]
    #[inline(always)]
    pub fn setd0pidef(&mut self) -> Setd0pidefW<'_, Devinep7CtlSpec> {
        Setd0pidefW::new(self, 28)
    }
    #[doc = "Bit 29 - Set DATA1 PID / odd Frame"]
    #[inline(always)]
    pub fn setd1pidof(&mut self) -> Setd1pidofW<'_, Devinep7CtlSpec> {
        Setd1pidofW::new(self, 29)
    }
    #[doc = "Bit 30 - Endpoint Disable"]
    #[inline(always)]
    pub fn epdis(&mut self) -> EpdisW<'_, Devinep7CtlSpec> {
        EpdisW::new(self, 30)
    }
    #[doc = "Bit 31 - Endpoint enable"]
    #[inline(always)]
    pub fn epena(&mut self) -> EpenaW<'_, Devinep7CtlSpec> {
        EpenaW::new(self, 31)
    }
}
#[doc = "No Description\n\nYou can [`read`](crate::Reg::read) this register and get [`devinep7_ctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`devinep7_ctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Devinep7CtlSpec;
impl crate::RegisterSpec for Devinep7CtlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`devinep7_ctl::R`](R) reader structure"]
impl crate::Readable for Devinep7CtlSpec {}
#[doc = "`write(|w| ..)` method takes [`devinep7_ctl::W`](W) writer structure"]
impl crate::Writable for Devinep7CtlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DEVINEP7_CTL to value 0"]
impl crate::Resettable for Devinep7CtlSpec {}

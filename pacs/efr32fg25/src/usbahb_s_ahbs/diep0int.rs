...
#[doc = "Field `INTKNTXFEMP` reader - In Token recvd when TXFIFO Empty"]
pub type IntkntxfempR = crate::BitReader;
#[doc = "Field `INTKNTXFEMP` writer - In Token recvd when TXFIFO Empty"]
...
#[doc = "Field `TXFEMP` writer - TX FIFO Empty"]
...
impl R {
    ...
    #[doc = "Bit 4 - In Token recvd when TXFIFO Empty"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 7 - TX FIFO Empty"]
    #[inline(always)]
    pub fn txfemp(&mut self) -> TxfempW<'_, Diep0intSpec> {
        TxfempW::new(self, 7)
    }
    #[doc = "Bit 8 - FIFO Underrun"]
    #[inline(always)]
    ...
    #[doc = "Bit 9 - BNA(Buffer Not Available) IRQ"]
    #[inline(always)]
    pub fn bnaintr(&mut self) -> BnaintrW<'_, Diep0intSpec> {
        BnaintrW::new(self, 9)
    }
    #[doc = "Bit 11 - Packet Drop Status"]
    #[inline(always)]
    ...
    #[doc = "Bit 14 - NYET Interrupt"]
    #[inline(always)]
    pub fn nyetintrpt(&mut self) -> NyetintrptW<'_, Diep0intSpec> {

...
pub type R = crate::R<Dieptxf8Spec>;
#[doc = "Register `DIEPTXF8` writer"]
pub type W = crate::W<Dieptxf8Spec>;
...
impl W {
    #[doc = "Bits 0:12 - IN EP FIFOn xmit RAM Start Addr"]
    #[inline(always)]
    pub fn inepntxfstaddr(&mut self) -> InepntxfstaddrW<'_, Dieptxf8Spec> {
        InepntxfstaddrW::new(self, 0)
    }
    #[doc = "Bits 16:25 - IN Endpoint TxFIFO Depth"]
    #[inline(always)]
    pub fn inepntxfdep(&mut self) -> InepntxfdepW<'_, Dieptxf8Spec> {
...
pub struct Dieptxf8Spec;
impl crate::RegisterSpec for Dieptxf8Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dieptxf8::R`](R) reader structure"]
impl crate::Readable for Dieptxf8Spec {}
#[doc = "`write(|w| ..)` method takes [`dieptxf8::W`](W) writer structure"]
impl crate::Writable for Dieptxf8Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DIEPTXF8 to value 0x0300_1b00"]
impl crate::Resettable for Dieptxf8Spec {
    const RESET_VALUE: u32 = 0x0300_1b00;
}

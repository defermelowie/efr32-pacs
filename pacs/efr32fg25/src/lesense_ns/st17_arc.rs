...
pub type R = crate::R<St17ArcSpec>;
#[doc = "Register `ST17_ARC` writer"]
pub type W = crate::W<St17ArcSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Sensor compare value"]
    #[inline(always)]
    pub fn scomp(&mut self) -> ScompW<'_, St17ArcSpec> {
        ScompW::new(self, 0)
    }
    #[doc = "Bits 4:7 - Sensor mask"]
    #[inline(always)]
    pub fn smask(&mut self) -> SmaskW<'_, St17ArcSpec> {
        SmaskW::new(self, 4)
    }
    #[doc = "Bits 8:12 - Current State"]
    #[inline(always)]
    pub fn curstate(&mut self) -> CurstateW<'_, St17ArcSpec> {
        CurstateW::new(self, 8)
    }
    #[doc = "Bits 13:15 - Configure transition action in normal mode"]
    #[inline(always)]
    pub fn prsact(&mut self) -> PrsactW<'_, St17ArcSpec> {
        PrsactW::new(self, 13)
    }
    #[doc = "Bits 16:20 - Next state index"]
    #[inline(always)]
    pub fn nextstate(&mut self) -> NextstateW<'_, St17ArcSpec> {
        NextstateW::new(self, 16)
    }
    #[doc = "Bit 21 - Set interrupt flag"]
    #[inline(always)]
    pub fn setif(&mut self) -> SetifW<'_, St17ArcSpec> {
        SetifW::new(self, 21)
    }
}
#[doc = "No Description\n\nYou can [`read`](crate::Reg::read) this register and get [`st17_arc::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`st17_arc::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct St17ArcSpec;
impl crate::RegisterSpec for St17ArcSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st17_arc::R`](R) reader structure"]
impl crate::Readable for St17ArcSpec {}
#[doc = "`write(|w| ..)` method takes [`st17_arc::W`](W) writer structure"]
impl crate::Writable for St17ArcSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ST17_ARC to value 0"]
impl crate::Resettable for St17ArcSpec {}

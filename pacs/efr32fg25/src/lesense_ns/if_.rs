...
impl W {
    #[doc = "Bit 0 - Channel"]
    #[inline(always)]
    pub fn ch0(&mut self) -> Ch0W<'_, IfSpec> {
        Ch0W::new(self, 0)
    }
    #[doc = "Bit 1 - Channel"]
    #[inline(always)]
    pub fn ch1(&mut self) -> Ch1W<'_, IfSpec> {
        Ch1W::new(self, 1)
    }
    #[doc = "Bit 2 - Channel"]
    #[inline(always)]
    pub fn ch2(&mut self) -> Ch2W<'_, IfSpec> {
        Ch2W::new(self, 2)
    }
    #[doc = "Bit 3 - Channel"]
    #[inline(always)]
    pub fn ch3(&mut self) -> Ch3W<'_, IfSpec> {
        Ch3W::new(self, 3)
    }
    #[doc = "Bit 4 - Channel"]
    #[inline(always)]
    pub fn ch4(&mut self) -> Ch4W<'_, IfSpec> {
        Ch4W::new(self, 4)
    }
    #[doc = "Bit 5 - Channel"]
    #[inline(always)]
    pub fn ch5(&mut self) -> Ch5W<'_, IfSpec> {
        Ch5W::new(self, 5)
    }
    #[doc = "Bit 6 - Channel"]
    #[inline(always)]
    pub fn ch6(&mut self) -> Ch6W<'_, IfSpec> {
        Ch6W::new(self, 6)
    }
    #[doc = "Bit 7 - Channel"]
    #[inline(always)]
    pub fn ch7(&mut self) -> Ch7W<'_, IfSpec> {
        Ch7W::new(self, 7)
    }
    #[doc = "Bit 8 - Channel"]
    #[inline(always)]
    pub fn ch8(&mut self) -> Ch8W<'_, IfSpec> {
        Ch8W::new(self, 8)
    }
    #[doc = "Bit 9 - Channel"]
    #[inline(always)]
    pub fn ch9(&mut self) -> Ch9W<'_, IfSpec> {
        Ch9W::new(self, 9)
    }
    #[doc = "Bit 10 - Channel"]
    #[inline(always)]
    pub fn ch10(&mut self) -> Ch10W<'_, IfSpec> {
        Ch10W::new(self, 10)
    }
    #[doc = "Bit 11 - Channel"]
    #[inline(always)]
    pub fn ch11(&mut self) -> Ch11W<'_, IfSpec> {
        Ch11W::new(self, 11)
    }
    #[doc = "Bit 12 - Channel"]
    #[inline(always)]
    pub fn ch12(&mut self) -> Ch12W<'_, IfSpec> {
        Ch12W::new(self, 12)
    }
    #[doc = "Bit 13 - Channel"]
    #[inline(always)]
    pub fn ch13(&mut self) -> Ch13W<'_, IfSpec> {
        Ch13W::new(self, 13)
    }
    #[doc = "Bit 14 - Channel"]
    #[inline(always)]
    pub fn ch14(&mut self) -> Ch14W<'_, IfSpec> {
        Ch14W::new(self, 14)
    }
    #[doc = "Bit 15 - Channel"]
    #[inline(always)]
    pub fn ch15(&mut self) -> Ch15W<'_, IfSpec> {
        Ch15W::new(self, 15)
    }
    #[doc = "Bit 16 - Scan Done"]
    #[inline(always)]
    pub fn scandone(&mut self) -> ScandoneW<'_, IfSpec> {
        ScandoneW::new(self, 16)
    }
    #[doc = "Bit 17 - Decoder"]
    #[inline(always)]
    pub fn dec(&mut self) -> DecW<'_, IfSpec> {
        DecW::new(self, 17)
    }
    #[doc = "Bit 18 - Result Watermark Level"]
    #[inline(always)]
    pub fn reswl(&mut self) -> ReswlW<'_, IfSpec> {
        ReswlW::new(self, 18)
    }
    #[doc = "Bit 19 - Result Overflow"]
    #[inline(always)]
    pub fn resof(&mut self) -> ResofW<'_, IfSpec> {
        ResofW::new(self, 19)
    }
    #[doc = "Bit 20 - Counter Overflow"]
    #[inline(always)]
    pub fn cntof(&mut self) -> CntofW<'_, IfSpec> {
        CntofW::new(self, 20)
    }
    #[doc = "Bit 21 - Result Underflow"]
    #[inline(always)]
    pub fn resuf(&mut self) -> ResufW<'_, IfSpec> {
        ResufW::new(self, 21)
    }
}

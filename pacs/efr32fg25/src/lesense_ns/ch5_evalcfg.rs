...
pub type R = crate::R<Ch5EvalcfgSpec>;
#[doc = "Register `CH5_EVALCFG` writer"]
pub type W = crate::W<Ch5EvalcfgSpec>;
...
impl W {
    #[doc = "Bit 2 - Send result to decoder"]
    #[inline(always)]
    pub fn decode(&mut self) -> DecodeW<'_, Ch5EvalcfgSpec> {
        DecodeW::new(self, 2)
    }
    #[doc = "Bit 3 - Select mode for threshold comparison"]
    #[inline(always)]
    pub fn comp(&mut self) -> CompW<'_, Ch5EvalcfgSpec> {
        CompW::new(self, 3)
    }
    #[doc = "Bits 4:5 - Enable storing of sensor sample in resul"]
    #[inline(always)]
    pub fn strsample(&mut self) -> StrsampleW<'_, Ch5EvalcfgSpec> {
        StrsampleW::new(self, 4)
    }
    #[doc = "Bit 6 - Enable inversion of result"]
    #[inline(always)]
    pub fn scanresinv(&mut self) -> ScanresinvW<'_, Ch5EvalcfgSpec> {
        ScanresinvW::new(self, 6)
    }
    #[doc = "Bits 8:9 - Configure evaluation mode"]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, Ch5EvalcfgSpec> {
        ModeW::new(self, 8)
    }
}
#[doc = "No Description\n\nYou can [`read`](crate::Reg::read) this register and get [`ch5_evalcfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch5_evalcfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ch5EvalcfgSpec;
impl crate::RegisterSpec for Ch5EvalcfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch5_evalcfg::R`](R) reader structure"]
impl crate::Readable for Ch5EvalcfgSpec {}
#[doc = "`write(|w| ..)` method takes [`ch5_evalcfg::W`](W) writer structure"]
impl crate::Writable for Ch5EvalcfgSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH5_EVALCFG to value 0"]
impl crate::Resettable for Ch5EvalcfgSpec {}

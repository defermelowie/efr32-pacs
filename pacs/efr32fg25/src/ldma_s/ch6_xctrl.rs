#[doc = "Register `CH6_XCTRL` reader"]
pub type R = crate::R<Ch6XctrlSpec>;
#[doc = "Register `CH6_XCTRL` writer"]
pub type W = crate::W<Ch6XctrlSpec>;
...
impl W {
    #[doc = "Bit 4 - Destination Interleave"]
    #[inline(always)]
    pub fn dstilen(&mut self) -> DstilenW<'_, Ch6XctrlSpec> {
        DstilenW::new(self, 4)
    }
    #[doc = "Bits 5:6 - Interleave Mode"]
    #[inline(always)]
    pub fn ilmode(&mut self) -> IlmodeW<'_, Ch6XctrlSpec> {
        IlmodeW::new(self, 5)
    }
    #[doc = "Bit 7 - Allow AHB buffering"]
    #[inline(always)]
    pub fn bufferable(&mut self) -> BufferableW<'_, Ch6XctrlSpec> {
        BufferableW::new(self, 7)
    }
}
#[doc = "Channel Extended Descriptor Control Register (Writes will only take effect when EN=1)\n\nYou can [`read`](crate::Reg::read) this register and get [`ch6_xctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch6_xctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ch6XctrlSpec;
impl crate::RegisterSpec for Ch6XctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch6_xctrl::R`](R) reader structure"]
impl crate::Readable for Ch6XctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`ch6_xctrl::W`](W) writer structure"]
impl crate::Writable for Ch6XctrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH6_XCTRL to value 0"]
impl crate::Resettable for Ch6XctrlSpec {}

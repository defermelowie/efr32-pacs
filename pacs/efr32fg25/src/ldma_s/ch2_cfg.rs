...
impl W {
    ...
    #[doc = "Bit 22 - Structure Fetch Bus Port"]
    #[inline(always)]
    pub fn structbusport(&mut self) -> StructbusportW<'_, Ch2CfgSpec> {
        StructbusportW::new(self, 22)
    }
    #[doc = "Bit 23 - Source Bus Port"]
    #[inline(always)]
    pub fn srcbusport(&mut self) -> SrcbusportW<'_, Ch2CfgSpec> {
        SrcbusportW::new(self, 23)
    }
    #[doc = "Bit 24 - Destination Bus Port"]
    #[inline(always)]
    pub fn dstbusport(&mut self) -> DstbusportW<'_, Ch2CfgSpec> {

#[doc = "Register `CH11_XCTRL` reader"]
pub type R = crate::R<Ch11XctrlSpec>;
#[doc = "Register `CH11_XCTRL` writer"]
pub type W = crate::W<Ch11XctrlSpec>;
...
impl W {
    #[doc = "Bit 4 - Destination Interleave"]
    #[inline(always)]
    pub fn dstilen(&mut self) -> DstilenW<'_, Ch11XctrlSpec> {
        DstilenW::new(self, 4)
    }
    #[doc = "Bits 5:6 - Interleave Mode"]
    #[inline(always)]
    pub fn ilmode(&mut self) -> IlmodeW<'_, Ch11XctrlSpec> {
        IlmodeW::new(self, 5)
    }
    #[doc = "Bit 7 - Allow AHB buffering"]
    #[inline(always)]
    pub fn bufferable(&mut self) -> BufferableW<'_, Ch11XctrlSpec> {
        BufferableW::new(self, 7)
    }
}
#[doc = "Channel Extended Descriptor Control Register (Writes will only take effect when EN=1)\n\nYou can [`read`](crate::Reg::read) this register and get [`ch11_xctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ch11_xctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ch11XctrlSpec;
impl crate::RegisterSpec for Ch11XctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch11_xctrl::R`](R) reader structure"]
impl crate::Readable for Ch11XctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`ch11_xctrl::W`](W) writer structure"]
impl crate::Writable for Ch11XctrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CH11_XCTRL to value 0"]
impl crate::Resettable for Ch11XctrlSpec {}

...
#[doc = "Field `RADIOAES` reader - RADIO AES DMA secure mode"]
pub type RadioaesR = crate::BitReader;
#[doc = "Field `RADIOAES` writer - RADIO AES DMA secure mode"]
...
#[doc = "Field `BUFC` reader - BUFC secure mode"]
pub type BufcR = crate::BitReader;
#[doc = "Field `BUFC` writer - BUFC secure mode"]
pub type BufcW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `LDMA0` reader - MCU LDMA port 0 secure mode"]
pub type Ldma0R = crate::BitReader;
#[doc = "Field `LDMA0` writer - MCU LDMA port 0 secure mode"]
pub type Ldma0W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `LDMA1` reader - MCU LDMA port 1 secure mode"]
pub type Ldma1R = crate::BitReader;
#[doc = "Field `LDMA1` writer - MCU LDMA port 1 secure mode"]
...
#[doc = "Field `RFLDMA` reader - RFLDMA secure mode"]
pub type RfldmaR = crate::BitReader;
#[doc = "Field `RFLDMA` writer - RFLDMA secure mode"]
...
#[doc = "Field `USB` reader - USB secure mode"]
pub type UsbR = crate::BitReader;
#[doc = "Field `USB` writer - USB secure mode"]
pub type UsbW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - RADIO AES DMA secure mode"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 2 - BUFC secure mode"]
    #[inline(always)]
    pub fn bufc(&mut self) -> BufcW<'_, Bmpusatd0Spec> {
        BufcW::new(self, 2)
    }
    #[doc = "Bit 3 - MCU LDMA port 0 secure mode"]
    #[inline(always)]
    pub fn ldma0(&mut self) -> Ldma0W<'_, Bmpusatd0Spec> {
        Ldma0W::new(self, 3)
    }
    #[doc = "Bit 4 - MCU LDMA port 1 secure mode"]
    #[inline(always)]
    pub fn ldma1(&mut self) -> Ldma1W<'_, Bmpusatd0Spec> {
        Ldma1W::new(self, 4)
    }
    #[doc = "Bit 5 - RFECA0 secure mode"]
    #[inline(always)]
    ...
    #[doc = "Bit 7 - RFLDMA secure mode"]
    #[inline(always)]
    pub fn rfldma(&mut self) -> RfldmaW<'_, Bmpusatd0Spec> {
        RfldmaW::new(self, 7)
    }
    #[doc = "Bit 8 - SEEXTDMA secure mode"]
    #[inline(always)]
    ...
    #[doc = "Bit 9 - USB secure mode"]
    #[inline(always)]
    pub fn usb(&mut self) -> UsbW<'_, Bmpusatd0Spec> {
        UsbW::new(self, 9)
    }
}
...
#[doc = "`reset()` method sets BMPUSATD0 to value 0x03ff"]

...
#[doc = "Field `IPKDECVAL` reader - EM01 Dec Peak Current Setting"]
pub type IpkdecvalR = crate::FieldReader;
#[doc = "Field `IPKDECVAL` writer - EM01 Dec Peak Current Setting"]
...
impl R {
    ...
    #[doc = "Bits 4:7 - EM01 Dec Peak Current Setting"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bits 4:7 - EM01 Dec Peak Current Setting"]
    #[inline(always)]
    pub fn ipkdecval(&mut self) -> IpkdecvalW<'_, Em01ctrl0Spec> {
...
#[doc = "`reset()` method sets EM01CTRL0 to value 0x0199"]
impl crate::Resettable for Em01ctrl0Spec {
    const RESET_VALUE: u32 = 0x0199;
}

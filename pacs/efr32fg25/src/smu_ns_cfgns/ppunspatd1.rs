...
#[doc = "Field `EUSART3` reader - EUSART3 Privileged Access"]
pub type Eusart3R = crate::BitReader;
#[doc = "Field `EUSART3` writer - EUSART3 Privileged Access"]
pub type Eusart3W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `EUSART4` reader - EUSART4 Privileged Access"]
pub type Eusart4R = crate::BitReader;
#[doc = "Field `EUSART4` writer - EUSART4 Privileged Access"]
...
#[doc = "Field `RFFPLL0` reader - RFFPLL0 Privileged Access"]
pub type Rffpll0R = crate::BitReader;
#[doc = "Field `RFFPLL0` writer - RFFPLL0 Privileged Access"]
pub type Rffpll0W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ETAMPDET` reader - ETAMPDET Privileged Access"]
pub type EtampdetR = crate::BitReader;
#[doc = "Field `ETAMPDET` writer - ETAMPDET Privileged Access"]
pub type EtampdetW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `BUFC` reader - BUFC Privileged Access"]
pub type BufcR = crate::BitReader;
#[doc = "Field `BUFC` writer - BUFC Privileged Access"]
...
#[doc = "Field `AHBUSBSYS` reader - AHBUSBSYS Privileged Access"]
pub type AhbusbsysR = crate::BitReader;
#[doc = "Field `AHBUSBSYS` writer - AHBUSBSYS Privileged Access"]
pub type AhbusbsysW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    #[doc = "Bit 0 - EUSART1 Privileged Access"]
    #[inline(always)]
    pub fn eusart1(&self) -> Eusart1R {
        Eusart1R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - EUSART2 Privileged Access"]
    #[inline(always)]
    pub fn eusart2(&self) -> Eusart2R {
        Eusart2R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - EUSART3 Privileged Access"]
    #[inline(always)]
    pub fn eusart3(&self) -> Eusart3R {
        Eusart3R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - EUSART4 Privileged Access"]
    #[inline(always)]
    pub fn eusart4(&self) -> Eusart4R {
        Eusart4R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - SYSRTC Privileged Access"]
    #[inline(always)]
    pub fn sysrtc(&self) -> SysrtcR {
        SysrtcR::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - DMEM Privileged Access"]
    #[inline(always)]
    pub fn dmem(&self) -> DmemR {
        DmemR::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - PFMXPPRF Privileged Access"]
    #[inline(always)]
    pub fn pfmxpprf(&self) -> PfmxpprfR {
        PfmxpprfR::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - RFFPLL0 Privileged Access"]
    #[inline(always)]
    pub fn rffpll0(&self) -> Rffpll0R {
        Rffpll0R::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bit 8 - ETAMPDET Privileged Access"]
    #[inline(always)]
    pub fn etampdet(&self) -> EtampdetR {
        EtampdetR::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - BUFC Privileged Access"]
    #[inline(always)]
    pub fn bufc(&self) -> BufcR {
        BufcR::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - RADIOAES Privileged Access"]
    #[inline(always)]
    pub fn radioaes(&self) -> RadioaesR {
        RadioaesR::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - SMU Privileged Access"]
    #[inline(always)]
    pub fn smu(&self) -> SmuR {
        SmuR::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 12 - SMUCFGNS Privileged Access"]
    #[inline(always)]
    pub fn smucfgns(&self) -> SmucfgnsR {
        SmucfgnsR::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - AHBUSBSYS Privileged Access"]
    #[inline(always)]
    pub fn ahbusbsys(&self) -> AhbusbsysR {
        AhbusbsysR::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - LETIMER0 Privileged Access"]
    #[inline(always)]
    pub fn letimer0(&self) -> Letimer0R {
        Letimer0R::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 15 - IADC0 Privileged Access"]
    #[inline(always)]
    pub fn iadc0(&self) -> Iadc0R {
        Iadc0R::new(((self.bits >> 15) & 1) != 0)
    }
    #[doc = "Bit 16 - ACMP0 Privileged Access"]
    #[inline(always)]
    pub fn acmp0(&self) -> Acmp0R {
        Acmp0R::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 17 - ACMP1 Privileged Access"]
    #[inline(always)]
    pub fn acmp1(&self) -> Acmp1R {
        Acmp1R::new(((self.bits >> 17) & 1) != 0)
    }
    #[doc = "Bit 18 - AMUXCP0 Privileged Access"]
    #[inline(always)]
    pub fn amuxcp0(&self) -> Amuxcp0R {
        Amuxcp0R::new(((self.bits >> 18) & 1) != 0)
    }
    #[doc = "Bit 19 - VDAC0 Privileged Access"]
    #[inline(always)]
    pub fn vdac0(&self) -> Vdac0R {
        Vdac0R::new(((self.bits >> 19) & 1) != 0)
    }
    #[doc = "Bit 20 - PCNT Privileged Access"]
    #[inline(always)]
    pub fn pcnt(&self) -> PcntR {
        PcntR::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 21 - LESENSE Privileged Access"]
    #[inline(always)]
    pub fn lesense(&self) -> LesenseR {
        LesenseR::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bit 22 - HFRCO1 Privileged Access"]
    #[inline(always)]
    pub fn hfrco1(&self) -> Hfrco1R {
        Hfrco1R::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 23 - HFXO0 Privileged Access"]
    #[inline(always)]
    pub fn hfxo0(&self) -> Hfxo0R {
        Hfxo0R::new(((self.bits >> 23) & 1) != 0)
    }
    #[doc = "Bit 24 - I2C0 Privileged Access"]
    #[inline(always)]
    pub fn i2c0(&self) -> I2c0R {
        I2c0R::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bit 25 - WDOG0 Privileged Access"]
    #[inline(always)]
    pub fn wdog0(&self) -> Wdog0R {
        Wdog0R::new(((self.bits >> 25) & 1) != 0)
    }
    #[doc = "Bit 26 - WDOG1 Privileged Access"]
    #[inline(always)]
    pub fn wdog1(&self) -> Wdog1R {
        Wdog1R::new(((self.bits >> 26) & 1) != 0)
    }
    #[doc = "Bit 27 - EUSART0 Privileged Access"]
    #[inline(always)]
    pub fn eusart0(&self) -> Eusart0R {
        Eusart0R::new(((self.bits >> 27) & 1) != 0)
    }
    #[doc = "Bit 28 - SEMAILBOX Privileged Access"]
    #[inline(always)]
    pub fn semailbox(&self) -> SemailboxR {
        SemailboxR::new(((self.bits >> 28) & 1) != 0)
    }
    #[doc = "Bit 29 - AHBRADIO Privileged Access"]
    #[inline(always)]
    pub fn ahbradio(&self) -> AhbradioR {
        AhbradioR::new(((self.bits >> 29) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - EUSART1 Privileged Access"]
    #[inline(always)]
    pub fn eusart1(&mut self) -> Eusart1W<'_, Ppunspatd1Spec> {
        Eusart1W::new(self, 0)
    }
    #[doc = "Bit 1 - EUSART2 Privileged Access"]
    #[inline(always)]
    pub fn eusart2(&mut self) -> Eusart2W<'_, Ppunspatd1Spec> {
        Eusart2W::new(self, 1)
    }
    #[doc = "Bit 2 - EUSART3 Privileged Access"]
    #[inline(always)]
    pub fn eusart3(&mut self) -> Eusart3W<'_, Ppunspatd1Spec> {
        Eusart3W::new(self, 2)
    }
    #[doc = "Bit 3 - EUSART4 Privileged Access"]
    #[inline(always)]
    pub fn eusart4(&mut self) -> Eusart4W<'_, Ppunspatd1Spec> {
        Eusart4W::new(self, 3)
    }
    #[doc = "Bit 4 - SYSRTC Privileged Access"]
    #[inline(always)]
    pub fn sysrtc(&mut self) -> SysrtcW<'_, Ppunspatd1Spec> {
        SysrtcW::new(self, 4)
    }
    #[doc = "Bit 5 - DMEM Privileged Access"]
    #[inline(always)]
    ...
    #[doc = "Bit 6 - PFMXPPRF Privileged Access"]
    #[inline(always)]
    pub fn pfmxpprf(&mut self) -> PfmxpprfW<'_, Ppunspatd1Spec> {
        PfmxpprfW::new(self, 6)
    }
    #[doc = "Bit 7 - RFFPLL0 Privileged Access"]
    #[inline(always)]
    pub fn rffpll0(&mut self) -> Rffpll0W<'_, Ppunspatd1Spec> {
        Rffpll0W::new(self, 7)
    }
    #[doc = "Bit 8 - ETAMPDET Privileged Access"]
    #[inline(always)]
    pub fn etampdet(&mut self) -> EtampdetW<'_, Ppunspatd1Spec> {
        EtampdetW::new(self, 8)
    }
    #[doc = "Bit 9 - BUFC Privileged Access"]
    #[inline(always)]
    pub fn bufc(&mut self) -> BufcW<'_, Ppunspatd1Spec> {
        BufcW::new(self, 9)
    }
    #[doc = "Bit 10 - RADIOAES Privileged Access"]
    #[inline(always)]
    pub fn radioaes(&mut self) -> RadioaesW<'_, Ppunspatd1Spec> {
        RadioaesW::new(self, 10)
    }
    #[doc = "Bit 11 - SMU Privileged Access"]
    #[inline(always)]
    ...
    pub fn smucfgns(&mut self) -> SmucfgnsW<'_, Ppunspatd1Spec> {
        SmucfgnsW::new(self, 12)
    }
    #[doc = "Bit 13 - AHBUSBSYS Privileged Access"]
    #[inline(always)]
    pub fn ahbusbsys(&mut self) -> AhbusbsysW<'_, Ppunspatd1Spec> {
        AhbusbsysW::new(self, 13)
    }
    #[doc = "Bit 14 - LETIMER0 Privileged Access"]
    #[inline(always)]
    pub fn letimer0(&mut self) -> Letimer0W<'_, Ppunspatd1Spec> {
        Letimer0W::new(self, 14)
    }
    #[doc = "Bit 15 - IADC0 Privileged Access"]
    #[inline(always)]
    ...
    #[doc = "Bit 21 - LESENSE Privileged Access"]
    #[inline(always)]
    pub fn lesense(&mut self) -> LesenseW<'_, Ppunspatd1Spec> {
        LesenseW::new(self, 21)
    }
    #[doc = "Bit 22 - HFRCO1 Privileged Access"]
    #[inline(always)]
...
#[doc = "`reset()` method sets PPUNSPATD1 to value 0x3fff_ffff"]

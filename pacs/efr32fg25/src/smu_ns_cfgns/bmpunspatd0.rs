...
impl W {
    ...
    #[doc = "Bit 2 - BUFC privileged mode"]
    #[inline(always)]
    pub fn bufc(&mut self) -> BufcW<'_, Bmpunspatd0Spec> {
        BufcW::new(self, 2)
    }
    #[doc = "Bit 3 - MCU LDMA port 0 privileged mode"]
    #[inline(always)]
    pub fn ldma0(&mut self) -> Ldma0W<'_, Bmpunspatd0Spec> {
        Ldma0W::new(self, 3)
    }
    #[doc = "Bit 4 - MCU LDMA port 1 privileged mode"]
    #[inline(always)]
    pub fn ldma1(&mut self) -> Ldma1W<'_, Bmpunspatd0Spec> {
        Ldma1W::new(self, 4)
    }
    #[doc = "Bit 5 - RFECA0 privileged mode"]
    #[inline(always)]
    ...
    #[doc = "Bit 7 - RFLDMA privileged mode"]
    #[inline(always)]
    pub fn rfldma(&mut self) -> RfldmaW<'_, Bmpunspatd0Spec> {
        RfldmaW::new(self, 7)
    }
    #[doc = "Bit 8 - SEEXTDMA privileged mode"]
    #[inline(always)]
    ...
    #[doc = "Bit 9 - USB privileged mode"]
    #[inline(always)]
    pub fn usb(&mut self) -> UsbW<'_, Bmpunspatd0Spec> {
        UsbW::new(self, 9)
    }
}
...
#[doc = "`reset()` method sets BMPUNSPATD0 to value 0x03ff"]

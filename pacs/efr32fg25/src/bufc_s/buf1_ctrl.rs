#[doc = "Register `BUF1_CTRL` reader"]
pub type R = crate::R<Buf1CtrlSpec>;
#[doc = "Register `BUF1_CTRL` writer"]
pub type W = crate::W<Buf1CtrlSpec>;
#[doc = "Buffer Size\n\nValue on reset: 0"]
...
impl W {
    #[doc = "Bits 0:2 - Buffer Size"]
    #[inline(always)]
    pub fn size(&mut self) -> SizeW<'_, Buf1CtrlSpec> {
        SizeW::new(self, 0)
    }
}
#[doc = "No Description\n\nYou can [`read`](crate::Reg::read) this register and get [`buf1_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`buf1_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Buf1CtrlSpec;
impl crate::RegisterSpec for Buf1CtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`buf1_ctrl::R`](R) reader structure"]
impl crate::Readable for Buf1CtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`buf1_ctrl::W`](W) writer structure"]
impl crate::Writable for Buf1CtrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets BUF1_CTRL to value 0"]
impl crate::Resettable for Buf1CtrlSpec {}

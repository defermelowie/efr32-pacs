#[doc = "Register `BUF2_THRESHOLDCTRL` reader"]
pub type R = crate::R<Buf2ThresholdctrlSpec>;
#[doc = "Register `BUF2_THRESHOLDCTRL` writer"]
pub type W = crate::W<Buf2ThresholdctrlSpec>;
...
impl W {
    #[doc = "Bits 0:12 - Buffer Threshold Value"]
    #[inline(always)]
    pub fn threshold(&mut self) -> ThresholdW<'_, Buf2ThresholdctrlSpec> {
        ThresholdW::new(self, 0)
    }
    #[doc = "Bit 13 - Buffer Threshold Mode"]
    #[inline(always)]
    pub fn thresholdmode(&mut self) -> ThresholdmodeW<'_, Buf2ThresholdctrlSpec> {
        ThresholdmodeW::new(self, 13)
    }
}
#[doc = "No Description\n\nYou can [`read`](crate::Reg::read) this register and get [`buf2_thresholdctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`buf2_thresholdctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Buf2ThresholdctrlSpec;
impl crate::RegisterSpec for Buf2ThresholdctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`buf2_thresholdctrl::R`](R) reader structure"]
impl crate::Readable for Buf2ThresholdctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`buf2_thresholdctrl::W`](W) writer structure"]
impl crate::Writable for Buf2ThresholdctrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets BUF2_THRESHOLDCTRL to value 0"]
impl crate::Resettable for Buf2ThresholdctrlSpec {}

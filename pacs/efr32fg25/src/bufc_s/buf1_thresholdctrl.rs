#[doc = "Register `BUF1_THRESHOLDCTRL` reader"]
pub type R = crate::R<Buf1ThresholdctrlSpec>;
#[doc = "Register `BUF1_THRESHOLDCTRL` writer"]
pub type W = crate::W<Buf1ThresholdctrlSpec>;
...
impl W {
    #[doc = "Bits 0:12 - Buffer Threshold Value"]
    #[inline(always)]
    pub fn threshold(&mut self) -> ThresholdW<'_, Buf1ThresholdctrlSpec> {
        ThresholdW::new(self, 0)
    }
    #[doc = "Bit 13 - Buffer Threshold Mode"]
    #[inline(always)]
    pub fn thresholdmode(&mut self) -> ThresholdmodeW<'_, Buf1ThresholdctrlSpec> {
        ThresholdmodeW::new(self, 13)
    }
}
#[doc = "No Description\n\nYou can [`read`](crate::Reg::read) this register and get [`buf1_thresholdctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`buf1_thresholdctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Buf1ThresholdctrlSpec;
impl crate::RegisterSpec for Buf1ThresholdctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`buf1_thresholdctrl::R`](R) reader structure"]
impl crate::Readable for Buf1ThresholdctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`buf1_thresholdctrl::W`](W) writer structure"]
impl crate::Writable for Buf1ThresholdctrlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets BUF1_THRESHOLDCTRL to value 0"]
impl crate::Resettable for Buf1ThresholdctrlSpec {}

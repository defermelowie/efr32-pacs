...
#[doc = "Field `RADIOSMDBGLOCK` reader - Radio Soft Modem Debug Lock"]
pub type RadiosmdbglockR = crate::BitReader;
...
impl R {
    ...
    #[doc = "Bit 21 - Radio Debug Lock"]
    #[inline(always)]
    pub fn radiodbglock(&self) -> RadiodbglockR {
        RadiodbglockR::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bit 22 - Radio Soft Modem Debug Lock"]
    #[inline(always)]
    pub fn radiosmdbglock(&self) -> RadiosmdbglockR {
        RadiosmdbglockR::new(((self.bits >> 22) & 1) != 0)
    }

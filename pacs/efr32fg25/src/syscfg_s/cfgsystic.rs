...
#[doc = "Field `SYSTICEXTCLKEN` reader - System-Tick External Clock Enable"]
pub type SysticextclkenR = crate::BitReader;
#[doc = "Field `SYSTICEXTCLKEN` writer - System-Tick External Clock Enable"]
pub type SysticextclkenW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - System-Tick External Clock Enable"]
    #[inline(always)]
